...
from copilot.models import CategoryEnum, ChunkPayload, ResponseEnum
...
class StreamHandler:
    ...
    def __init__(self):
        ...
        self.skip_next_agent_response: bool = False
                ...
                if isinstance(message, AIMessage):
                    ...
                    if finish_reason == "tool_calls":
                        ...
                        if tool and tool.get("name") != "user-assistance":
                            ...
                            # Set flag to skip next agent response for certain tools
                            if self.tool_name in ["search_vendors", "ask_feedback"]:
                                self.skip_next_agent_response = True
                            ...
                            yield payload.model_dump_json()
                    elif finish_reason == "stop" and self.skip_next_agent_response:
                        # Skip agent responses that come after certain tool calls to avoid duplicate responses
                        self.skip_next_agent_response = False
                        return
