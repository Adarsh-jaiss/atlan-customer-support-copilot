# Source URL
https://developer.atlan.com/models/entities/adfactivity/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/adfactivity/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/adfactivity.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AdfActivity - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/adfactivity/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/adfactivity.png
meta-twitter:title: AdfActivity - Developer
meta-viewport: width=device-width,initial-scale=1
title: AdfActivity - Developer
-->

[Skip to content](#adfactivity) Developer AdfActivity Initializing search 
...
AdfActivity[¶](#adfactivity "Permanent link")
=============================================
...
This is a complete reference for the `AdfActivity` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AdfActivity` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `AdfActivity`'s supertypes (shown above):
...
These attributes are specific to instances of `AdfActivity` (and all of its subtypes).

### adfActivityBatchCount [¶](#adfactivitybatchcount "Permanent link")

Defines the batch count of activity to runs in ForEach activity.

### adfActivityFirstRowOnly [¶](#adfactivityfirstrowonly "Permanent link")

Indicates whether to import only first row only or not in Lookup activity.

### adfActivityIsSequential [¶](#adfactivityissequential "Permanent link")

Indicates whether the activity processing is sequential or not inside the ForEach activity.

### adfActivityMainClassName [¶](#adfactivitymainclassname "Permanent link")

Defines the main class of the databricks spark activity.

### adfActivityNotebookPath [¶](#adfactivitynotebookpath "Permanent link")

Defines the path of the notebook in the databricks notebook activity.

### adfActivityPolictRetryInterval [¶](#adfactivitypolictretryinterval "Permanent link")

The retry interval in seconds for the ADF activity.

### adfActivityPolicyTimeout [¶](#adfactivitypolicytimeout "Permanent link")

The timout defined for the ADF activity.

### adfActivityPrecedingDependency [¶](#adfactivityprecedingdependency "Permanent link")
...
### adfActivityPythonFilePath [¶](#adfactivitypythonfilepath "Permanent link")

Defines the python file path for databricks python activity.

### adfActivityReferenceDataflow [¶](#adfactivityreferencedataflow "Permanent link")

Defines the dataflow that is to be used in dataflow activity.

### adfActivityRuns [¶](#adfactivityruns "Permanent link")

List of objects of activity runs for a particular activity.

### adfActivitySinkType [¶](#adfactivitysinktype "Permanent link")

Defines the type of the sink of the ADF activtity.

### adfActivitySinks [¶](#adfactivitysinks "Permanent link")

The list of names of sinks for the ADF activity.

### adfActivitySourceType [¶](#adfactivitysourcetype "Permanent link")

Defines the type of the source of the ADF activtity.

### adfActivitySources [¶](#adfactivitysources "Permanent link")
...
### adfActivitySubActivities [¶](#adfactivitysubactivities "Permanent link")

The list of activities to be run inside a ForEach activity.

### adfActivityType [¶](#adfactivitytype "Permanent link")

The type of the ADF activity.

### adfPipelineQualifiedName [¶](#adfpipelinequalifiedname "Permanent link")
...
These relationships are inherited from `AdfActivity`'s supertypes:
...
These relationships are specific to instances of `AdfActivity` (and all of its subtypes).

### adfDataflow  ([AdfDataflow](../adfdataflow/))[¶](#adfdataflow-adfdataflow "Permanent link")
...
### adfLinkedservices  ([AdfLinkedservice](../adflinkedservice/))[¶](#adflinkedservices-adflinkedservice "Permanent link")

ADF activities that are associated with this ADF Linkedservice.

### adfPipeline  ([AdfPipeline](../adfpipeline/))[¶](#adfpipeline-adfpipeline "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/adfactivity/) to provide us with more information. 

Back to top

[Previous Azure Data Factory](../../adf/) [Next AdfDataflow](../adfdataflow/) 
