# Source URL
https://developer.atlan.com/models/entities/adfdataset/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/adfdataset/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/adfdataset.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AdfDataset - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/adfdataset/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/adfdataset.png
meta-twitter:title: AdfDataset - Developer
meta-viewport: width=device-width,initial-scale=1
title: AdfDataset - Developer
-->

[Skip to content](#adfdataset) Developer AdfDataset Initializing search 
...
AdfDataset[¶](#adfdataset "Permanent link")
===========================================
...
This is a complete reference for the `AdfDataset` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AdfDataset` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AdfDataset
    link AdfDataset "../adfdataset"
    class ADF {
        <<abstract>>
    }
    link ADF "../adf"
...
These attributes are inherited from `AdfDataset`'s supertypes (shown above):
...
These attributes are specific to instances of `AdfDataset` (and all of its subtypes).

### adfDatasetAnnotations [¶](#adfdatasetannotations "Permanent link")

The list of annotation assigned to a dataset.

### adfDatasetCollectionName [¶](#adfdatasetcollectionname "Permanent link")

Defines the name collection in the cosmos dataset.

### adfDatasetContainerName [¶](#adfdatasetcontainername "Permanent link")

Defines the container or bucket name in the storage file system dataset.

### adfDatasetDatabaseName [¶](#adfdatasetdatabasename "Permanent link")

Defines the name of the database used in the azure delta lake type of dataset.

### adfDatasetFileFolderPath [¶](#adfdatasetfilefolderpath "Permanent link")

Defines the folder path of the file in the storage file system dataset.

### adfDatasetFileName [¶](#adfdatasetfilename "Permanent link")

Defines the name of the file in the storage file system dataset.

### adfDatasetLinkedService [¶](#adfdatasetlinkedservice "Permanent link")

Defines the name of the linked service used to create this dataset.

### adfDatasetSchemaName [¶](#adfdatasetschemaname "Permanent link")

Defines the name of the schema used in the snowflake, mssql, azure sql database type of dataset.

### adfDatasetStorageType [¶](#adfdatasetstoragetype "Permanent link")

Defines the storage type of storage file system dataset.

### adfDatasetTableName [¶](#adfdatasettablename "Permanent link")

Defines the name of the table used in the snowflake, mssql, azure sql database type of dataset.

### adfDatasetType [¶](#adfdatasettype "Permanent link")
...
These relationships are inherited from `AdfDataset`'s supertypes:
...
These relationships are specific to instances of `AdfDataset` (and all of its subtypes).
...
### adfLinkedservice  ([AdfLinkedservice](../adflinkedservice/))[¶](#adflinkedservice-adflinkedservice "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/adfdataset/) to provide us with more information. 

Back to top

[Previous AdfDataflow](../adfdataflow/) [Next AdfLinkedservice](../adflinkedservice/) 
