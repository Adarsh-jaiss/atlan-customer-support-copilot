# Source URL
https://developer.atlan.com/models/entities/adflinkedservice/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/adflinkedservice/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/adflinkedservice.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AdfLinkedservice - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/adflinkedservice/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/adflinkedservice.png
meta-twitter:title: AdfLinkedservice - Developer
meta-viewport: width=device-width,initial-scale=1
title: AdfLinkedservice - Developer
-->

[Skip to content](#adflinkedservice) Developer AdfLinkedservice Initializing search 
...
AdfLinkedservice[¶](#adflinkedservice "Permanent link")
=======================================================
...
This is a complete reference for the `AdfLinkedservice` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AdfLinkedservice` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AdfLinkedservice
    link AdfLinkedservice "../adflinkedservice"
    class ADF {
        <<abstract>>
    }
    link ADF "../adf"
...
These attributes are inherited from `AdfLinkedservice`'s supertypes (shown above):
...
These attributes are specific to instances of `AdfLinkedservice` (and all of its subtypes).

### adfLinkedserviceAccountName [¶](#adflinkedserviceaccountname "Permanent link")

Defines the name of the account used in the cosmos linked service.

### adfLinkedserviceAnnotations [¶](#adflinkedserviceannotations "Permanent link")

The list of annotation assigned to a linked service.

### adfLinkedserviceAzureCloudType [¶](#adflinkedserviceazurecloudtype "Permanent link")

Defines the type of cloud being used in the ADLS linked service.

### adfLinkedserviceClusterId [¶](#adflinkedserviceclusterid "Permanent link")

Defines the cluster id in the Azure databricks delta lake linked service.

### adfLinkedserviceCredentialType [¶](#adflinkedservicecredentialtype "Permanent link")

Defines the type of credential, authentication being used in the ADLS, snowflake, azure sql linked service.

### adfLinkedserviceDatabaseName [¶](#adflinkedservicedatabasename "Permanent link")

Defines the name of the database used in the cosmos, snowflake linked service.

### adfLinkedserviceDomainEndpoint [¶](#adflinkedservicedomainendpoint "Permanent link")

Defines the url, domain, account\_identifier, server in the ADLS, Azure databricks delta lake, snowflake, azure sql linked service.

### adfLinkedserviceResourceId [¶](#adflinkedserviceresourceid "Permanent link")

Defines the resource id in the Azure databricks delta lake linked service.

### adfLinkedserviceRoleName [¶](#adflinkedservicerolename "Permanent link")

Defines the name of the role in the snowflake linked service.

### adfLinkedserviceTenant [¶](#adflinkedservicetenant "Permanent link")

Defines the tenant of cloud being used in the ADLS linked service.

### adfLinkedserviceType [¶](#adflinkedservicetype "Permanent link")

Defines the type of the linked service.

### adfLinkedserviceUserName [¶](#adflinkedserviceusername "Permanent link")

Defines the name of the db user in the snowflake linked service.

### adfLinkedserviceVersion [¶](#adflinkedserviceversion "Permanent link")

Defines the version of the linked service in the cosmos linked service.

### adfLinkedserviceVersionAbove [¶](#adflinkedserviceversionabove "Permanent link")

Indicates whether the service version is above 3\.2 or not in the cosmos linked service.

### adfLinkedserviceWarehouseName [¶](#adflinkedservicewarehousename "Permanent link")
...
These relationships are inherited from `AdfLinkedservice`'s supertypes:
...
These relationships are specific to instances of `AdfLinkedservice` (and all of its subtypes).

### adfActivities  ([AdfActivity](../adfactivity/))[¶](#adfactivities-adfactivity "Permanent link")

ADF Linkedservice that is associated with these ADF activities.

### adfDataflows  ([AdfDataflow](../adfdataflow/))[¶](#adfdataflows-adfdataflow "Permanent link")

ADF Linkedservices that are associated with this ADF Dataflows.

### adfDatasets  ([AdfDataset](../adfdataset/))[¶](#adfdatasets-adfdataset "Permanent link")

ADF Linkedservice that is associated with these ADF datasets.

### adfPipelines  ([AdfPipeline](../adfpipeline/))[¶](#adfpipelines-adfpipeline "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/adflinkedservice/) to provide us with more information. 

Back to top

[Previous AdfDataset](../adfdataset/) [Next AdfPipeline](../adfpipeline/) 
