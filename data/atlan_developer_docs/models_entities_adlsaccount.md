# Source URL
https://developer.atlan.com/models/entities/adlsaccount/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/adlsaccount/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/adlsaccount.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ADLSAccount - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/adlsaccount/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/adlsaccount.png
meta-twitter:title: ADLSAccount - Developer
meta-viewport: width=device-width,initial-scale=1
title: ADLSAccount - Developer
-->

[Skip to content](#adlsaccount) Developer ADLSAccount Initializing search 
...
This is a complete reference for the `ADLSAccount` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ADLSAccount` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class ADLSAccount
    link ADLSAccount "../adlsaccount"
    class ADLS {
        <<abstract>>
    }
    link ADLS "../adls"
...
These attributes are inherited from `ADLSAccount`'s supertypes (shown above):
...
These attributes are specific to instances of `ADLSAccount` (and all of its subtypes).

### adlsAccountAccessTier [¶](#adlsaccountaccesstier "Permanent link")

Access tier of this account.

### adlsAccountKind [¶](#adlsaccountkind "Permanent link")

Kind of this account.

### adlsAccountPerformance [¶](#adlsaccountperformance "Permanent link")

Performance of this account.

### adlsAccountProvisionState [¶](#adlsaccountprovisionstate "Permanent link")

Provision state of this account.

### adlsAccountReplication [¶](#adlsaccountreplication "Permanent link")

Replication of this account.

### adlsAccountResourceGroup [¶](#adlsaccountresourcegroup "Permanent link")

Resource group for this account.

### adlsAccountSubscription [¶](#adlsaccountsubscription "Permanent link")

Subscription for this account.

### adlsETag [¶](#adlsetag "Permanent link")

Entity tag for the asset. An entity tag is a hash of the object and represents changes to the contents of an object only, not its metadata.

### adlsEncryptionType [¶](#adlsencryptiontype "Permanent link")

Type of encryption for this account.

### adlsPrimaryDiskState [¶](#adlsprimarydiskstate "Permanent link")
...
These relationships are inherited from `ADLSAccount`'s supertypes:
...
These relationships are specific to instances of `ADLSAccount` (and all of its subtypes).

### adlsContainers  ([ADLSContainer](../adlscontainer/))[¶](#adlscontainers-adlscontainer "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/adlsaccount/) to provide us with more information. 

Back to top

[Previous ADLS](../../adls/) [Next ADLSContainer](../adlscontainer/) 
