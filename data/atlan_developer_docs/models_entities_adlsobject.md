# Source URL
https://developer.atlan.com/models/entities/adlsobject/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/adlsobject/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/adlsobject.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ADLSObject - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/adlsobject/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/adlsobject.png
meta-twitter:title: ADLSObject - Developer
meta-viewport: width=device-width,initial-scale=1
title: ADLSObject - Developer
-->

[Skip to content](#adlsobject) Developer ADLSObject Initializing search 
...
This is a complete reference for the `ADLSObject` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ADLSObject` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class ADLSObject
    link ADLSObject "../adlsobject"
    class ADLS {
        <<abstract>>
    }
    link ADLS "../adls"
...
These attributes are inherited from `ADLSObject`'s supertypes (shown above):
...
These attributes are specific to instances of `ADLSObject` (and all of its subtypes).

### adlsContainerQualifiedName [¶](#adlscontainerqualifiedname "Permanent link")

Unique name of the container this object exists within.

### adlsObjectAccessTier [¶](#adlsobjectaccesstier "Permanent link")

Access tier of this object.

### adlsObjectAccessTierLastModifiedTime [¶](#adlsobjectaccesstierlastmodifiedtime "Permanent link")
...
### adlsObjectCacheControl [¶](#adlsobjectcachecontrol "Permanent link")

Cache control of this object.

### adlsObjectContentLanguage [¶](#adlsobjectcontentlanguage "Permanent link")

Language of this object's contents.

### adlsObjectContentMD5Hash [¶](#adlsobjectcontentmd5hash "Permanent link")

MD5 hash of this object's contents.

### adlsObjectContentType [¶](#adlsobjectcontenttype "Permanent link")

Content type of this object.

### adlsObjectLeaseState [¶](#adlsobjectleasestate "Permanent link")

State of this object's lease.

### adlsObjectLeaseStatus [¶](#adlsobjectleasestatus "Permanent link")

Status of this object's lease.

### adlsObjectMetadata [¶](#adlsobjectmetadata "Permanent link")

Metadata associated with this object, from ADLS.

### adlsObjectServerEncrypted [¶](#adlsobjectserverencrypted "Permanent link")

Whether this object is server encrypted (true) or not (false).

### adlsObjectSize [¶](#adlsobjectsize "Permanent link")
...
### adlsObjectUrl [¶](#adlsobjecturl "Permanent link")

URL of this object.

### adlsObjectVersionId [¶](#adlsobjectversionid "Permanent link")

Identifier of the version of this object, from ADLS.

### adlsObjectVersionLevelImmutabilitySupport [¶](#adlsobjectversionlevelimmutabilitysupport "Permanent link")
...
These relationships are inherited from `ADLSObject`'s supertypes:
...
These relationships are specific to instances of `ADLSObject` (and all of its subtypes).

### adlsContainer  ([ADLSContainer](../adlscontainer/))[¶](#adlscontainer-adlscontainer "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/adlsobject/) to provide us with more information. 

Back to top

[Previous ADLSContainer](../adlscontainer/) [Next AzureEventHub](../azureeventhub/) 
