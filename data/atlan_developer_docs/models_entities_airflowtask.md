# Source URL
https://developer.atlan.com/models/entities/airflowtask/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/airflowtask/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/airflowtask.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AirflowTask - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/airflowtask/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/airflowtask.png
meta-twitter:title: AirflowTask - Developer
meta-viewport: width=device-width,initial-scale=1
title: AirflowTask - Developer
-->

[Skip to content](#airflowtask) Developer AirflowTask Initializing search 
...
This is a complete reference for the `AirflowTask` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AirflowTask` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AirflowTask
    link AirflowTask "../airflowtask"
    class Airflow {
        <<abstract>>
    }
...
These attributes are inherited from `AirflowTask`'s supertypes (shown above):
...
These attributes are specific to instances of `AirflowTask` (and all of its subtypes).

### airflowDagName [¶](#airflowdagname "Permanent link")

Simple name of the DAG this task is contained within.

### airflowDagQualifiedName [¶](#airflowdagqualifiedname "Permanent link")

Unique name of the DAG this task is contained within.

### airflowTaskConnectionId [¶](#airflowtaskconnectionid "Permanent link")

Identifier for the connection this task accesses.

### airflowTaskGroupName [¶](#airflowtaskgroupname "Permanent link")

Group name for the task.

### airflowTaskOperatorClass [¶](#airflowtaskoperatorclass "Permanent link")

Class name for the operator this task uses.

### airflowTaskPool [¶](#airflowtaskpool "Permanent link")

Pool on which this run happened.

### airflowTaskPoolSlots [¶](#airflowtaskpoolslots "Permanent link")

Pool slots used for the run.

### airflowTaskPriorityWeight [¶](#airflowtaskpriorityweight "Permanent link")

Priority of the run.

### airflowTaskQueue [¶](#airflowtaskqueue "Permanent link")

Queue on which this run happened.

### airflowTaskRetryNumber [¶](#airflowtaskretrynumber "Permanent link")

Retry count for this task running.

### airflowTaskSql [¶](#airflowtasksql "Permanent link")

SQL code that executes through this task.

### airflowTaskTriggerRule [¶](#airflowtasktriggerrule "Permanent link")
...
These relationships are inherited from `AirflowTask`'s supertypes:
...
### inputToAirflowTasks  ([AirflowTask](./))[¶](#inputtoairflowtasks-airflowtask "Permanent link")
...
### outputFromAirflowTasks  ([AirflowTask](./))[¶](#outputfromairflowtasks-airflowtask "Permanent link")
...
These relationships are specific to instances of `AirflowTask` (and all of its subtypes).

### airflowDag  ([AirflowDag](../airflowdag/))[¶](#airflowdag-airflowdag "Permanent link")

DAG in which this task exists.

### inputs  ([Catalog](../catalog/))[¶](#inputs-catalog "Permanent link")

Assets that are inputs to this task.

### outputs  ([Catalog](../catalog/))[¶](#outputs-catalog "Permanent link")

Assets that are outputs from this task.

### process  ([Process](../../lineage/))[¶](#process-process "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/airflowtask/) to provide us with more information. 

Back to top

[Previous AirflowDag](../airflowdag/) [Next Amazon AWS](../../amazon/) 
