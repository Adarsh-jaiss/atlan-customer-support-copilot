# Source URL
https://developer.atlan.com/models/entities/anaplandimension/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/anaplandimension/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/anaplandimension.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AnaplanDimension - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/anaplandimension/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/anaplandimension.png
meta-twitter:title: AnaplanDimension - Developer
meta-viewport: width=device-width,initial-scale=1
title: AnaplanDimension - Developer
-->

[Skip to content](#anaplandimension) Developer AnaplanDimension Initializing search 
...
AnaplanDimension[¶](#anaplandimension "Permanent link")
=======================================================
...
This is a complete reference for the `AnaplanDimension` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AnaplanDimension` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AnaplanDimension
    link AnaplanDimension "../anaplandimension"
    class Anaplan {
        <<abstract>>
    }
...
These attributes are inherited from `AnaplanDimension`'s supertypes (shown above):
...
These relationships are inherited from `AnaplanDimension`'s supertypes:
...
These relationships are specific to instances of `AnaplanDimension` (and all of its subtypes).

### anaplanColumnViews  ([AnaplanView](../anaplanview/))[¶](#anaplancolumnviews-anaplanview "Permanent link")

AnaplanView assets containing this AnaplanDimension as a Column type dimension.

### anaplanLineItems  ([AnaplanLineItem](../anaplanlineitem/))[¶](#anaplanlineitems-anaplanlineitem "Permanent link")

AnaplanLineItem assets containing this AnaplanDimension.

### anaplanModel  ([AnaplanModel](../anaplanmodel/))[¶](#anaplanmodel-anaplanmodel "Permanent link")

AnaplanModel asset containing this AnaplanDimension.

### anaplanPageViews  ([AnaplanView](../anaplanview/))[¶](#anaplanpageviews-anaplanview "Permanent link")

AnaplanView assets containing this AnaplanDimension as a Page type dimension.

### anaplanRowViews  ([AnaplanView](../anaplanview/))[¶](#anaplanrowviews-anaplanview "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/anaplandimension/) to provide us with more information. 

Back to top

[Previous AnaplanSystemDimension](../anaplansystemdimension/) [Next AnaplanLineItem](../anaplanlineitem/) 
