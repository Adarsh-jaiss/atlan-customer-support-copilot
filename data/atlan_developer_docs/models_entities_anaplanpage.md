# Source URL
https://developer.atlan.com/models/entities/anaplanpage/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/anaplanpage/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/anaplanpage.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AnaplanPage - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/anaplanpage/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/anaplanpage.png
meta-twitter:title: AnaplanPage - Developer
meta-viewport: width=device-width,initial-scale=1
title: AnaplanPage - Developer
-->

[Skip to content](#anaplanpage) Developer AnaplanPage Initializing search 
...
AnaplanPage[¶](#anaplanpage "Permanent link")
=============================================
...
This is a complete reference for the `AnaplanPage` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AnaplanPage` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AnaplanPage
    link AnaplanPage "../anaplanpage"
    class Anaplan {
        <<abstract>>
    }
...
These attributes are inherited from `AnaplanPage`'s supertypes (shown above):
...
These attributes are specific to instances of `AnaplanPage` (and all of its subtypes).

### anaplanAppQualifiedName [¶](#anaplanappqualifiedname "Permanent link")

Unique name of the AnaplanApp asset that contains this asset.

### anaplanPageCategoryName [¶](#anaplanpagecategoryname "Permanent link")

Category Name of the AnaplanPage from the source system.

### anaplanPageType [¶](#anaplanpagetype "Permanent link")
...
These relationships are inherited from `AnaplanPage`'s supertypes:
...
These relationships are specific to instances of `AnaplanPage` (and all of its subtypes).

### anaplanApp  ([AnaplanApp](../anaplanapp/))[¶](#anaplanapp-anaplanapp "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/anaplanpage/) to provide us with more information. 

Back to top

[Previous AnaplanApp](../anaplanapp/) [Next AnaplanModel](../anaplanmodel/) 
