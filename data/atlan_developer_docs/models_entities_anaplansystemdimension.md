# Source URL
https://developer.atlan.com/models/entities/anaplansystemdimension/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/anaplansystemdimension/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/anaplansystemdimension.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AnaplanSystemDimension - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/anaplansystemdimension/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/anaplansystemdimension.png
meta-twitter:title: AnaplanSystemDimension - Developer
meta-viewport: width=device-width,initial-scale=1
title: AnaplanSystemDimension - Developer
-->

[Skip to content](#anaplansystemdimension) Developer AnaplanSystemDimension Initializing search 
...
AnaplanSystemDimension[¶](#anaplansystemdimension "Permanent link")
===================================================================
...
This is a complete reference for the `AnaplanSystemDimension` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AnaplanSystemDimension` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AnaplanSystemDimension
    link AnaplanSystemDimension "../anaplansystemdimension"
    class Anaplan {
        <<abstract>>
    }
...
These attributes are inherited from `AnaplanSystemDimension`'s supertypes (shown above):
...
These relationships are inherited from `AnaplanSystemDimension`'s supertypes:
...
2023\-01\-042025\-02\-07

**Was this page helpful?**

Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/anaplansystemdimension/) to provide us with more information. 

Back to top

[Previous AnaplanList](../anaplanlist/) [Next AnaplanDimension](../anaplandimension/) 
