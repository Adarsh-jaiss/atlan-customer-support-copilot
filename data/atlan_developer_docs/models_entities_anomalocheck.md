# Source URL
https://developer.atlan.com/models/entities/anomalocheck/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/anomalocheck/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/anomalocheck.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AnomaloCheck - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/anomalocheck/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/anomalocheck.png
meta-twitter:title: AnomaloCheck - Developer
meta-viewport: width=device-width,initial-scale=1
title: AnomaloCheck - Developer
-->

[Skip to content](#anomalocheck) Developer AnomaloCheck Initializing search 
...
AnomaloCheck[¶](#anomalocheck "Permanent link")
===============================================
...
This is a complete reference for the `AnomaloCheck` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AnomaloCheck` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AnomaloCheck
    link AnomaloCheck "../anomalocheck"
    class Anomalo {
        <<abstract>>
    }
    link Anomalo "../anomalo"
...
These attributes are inherited from `AnomaloCheck`'s supertypes (shown above):
...
These attributes are specific to instances of `AnomaloCheck` (and all of its subtypes).

### anomaloCheckCategoryType [¶](#anomalocheckcategorytype "Permanent link")

Category type of the check in Anomalo

### anomaloCheckHistoricRunStatus [¶](#anomalocheckhistoricrunstatus "Permanent link")

Historic run status of the check in Anomalo

### anomaloCheckIsSystemAdded [¶](#anomalocheckissystemadded "Permanent link")

Flag to indicate if the check is an out of the box available check

### anomaloCheckLastRunCompletedAt [¶](#anomalochecklastruncompletedat "Permanent link")

Timestamp when the check was last run

### anomaloCheckLastRunEvaluatedMessage [¶](#anomalochecklastrunevaluatedmessage "Permanent link")

Evaluated message of the latest check run.

### anomaloCheckLastRunUrl [¶](#anomalochecklastrunurl "Permanent link")

URL to the latest check run.

### anomaloCheckLinkedAssetQualifiedName [¶](#anomalochecklinkedassetqualifiedname "Permanent link")

QualifiedName of the asset associated with the check

### anomaloCheckPriorityLevel [¶](#anomalocheckprioritylevel "Permanent link")

Priority level of the check in Anomalo

### anomaloCheckStatus [¶](#anomalocheckstatus "Permanent link")

Status of the check in Anomalo

### anomaloCheckStatusImageUrl [¶](#anomalocheckstatusimageurl "Permanent link")

Image URL for the status of the check in Anomalo

### anomaloCheckType [¶](#anomalochecktype "Permanent link")
...
These relationships are inherited from `AnomaloCheck`'s supertypes:

### anomaloChecks  ([AnomaloCheck](./))[¶](#anomalochecks-anomalocheck "Permanent link")
...
These relationships are specific to instances of `AnomaloCheck` (and all of its subtypes).

### anomaloCheckAsset  ([Asset](../asset/))[¶](#anomalocheckasset-asset "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/anomalocheck/) to provide us with more information. 

Back to top

[Previous Anomalo](../../anomalo/) [Next App](../../app/) 
