...
<!--
canonical: https://developer.atlan.com/models/entities/apispec/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/apispec.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: APISpec - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/apispec/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/apispec.png
meta-twitter:title: APISpec - Developer
meta-viewport: width=device-width,initial-scale=1
title: APISpec - Developer
-->

[Skip to content](#apispec) Developer APISpec Initializing search 
...
This is a complete reference for the `APISpec` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`APISpec` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `APISpec`'s supertypes (shown above):
...
These attributes are specific to instances of `APISpec` (and all of its subtypes).

### apiSpecContactEmail [¶](#apispeccontactemail "Permanent link")

Email address for a contact responsible for the API specification.

### apiSpecContactName [¶](#apispeccontactname "Permanent link")

Name of the contact responsible for the API specification.

### apiSpecContactURL [¶](#apispeccontacturl "Permanent link")

URL pointing to the contact information.

### apiSpecContractVersion [¶](#apispeccontractversion "Permanent link")

Version of the contract for the API specification.

### apiSpecLicenseName [¶](#apispeclicensename "Permanent link")

Name of the license under which the API specification is available.

### apiSpecLicenseURL [¶](#apispeclicenseurl "Permanent link")

URL to the license under which the API specification is available.

### apiSpecServiceAlias [¶](#apispecservicealias "Permanent link")

Service alias for the API specification.

### apiSpecTermsOfServiceURL [¶](#apispectermsofserviceurl "Permanent link")
...
These relationships are inherited from `APISpec`'s supertypes:
...
These relationships are specific to instances of `APISpec` (and all of its subtypes).

### apiPaths  ([APIPath](../apipath/))[¶](#apipaths-apipath "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/apispec/) to provide us with more information. 

Back to top

[Previous APIPath](../apipath/) [Next APIObject](../apiobject/) 
