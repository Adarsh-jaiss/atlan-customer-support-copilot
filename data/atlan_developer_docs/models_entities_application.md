# Source URL
https://developer.atlan.com/models/entities/application/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/application/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/application.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Application - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/application/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/application.png
meta-twitter:title: Application - Developer
meta-viewport: width=device-width,initial-scale=1
title: Application - Developer
-->

[Skip to content](#application) Developer Application Initializing search 
...
This is a complete reference for the `Application` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`Application` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `Application`'s supertypes (shown above):
...
These relationships are inherited from `Application`'s supertypes:

### anomaloChecks  ([AnomaloCheck](../anomalocheck/))[¶](#anomalochecks-anomalocheck "Permanent link")

Checks that run on this asset.

### application  ([Application](./))[¶](#application-application "Permanent link")
...
These relationships are specific to instances of `Application` (and all of its subtypes).

### applicationChildFields  ([ApplicationField](../applicationfield/))[¶](#applicationchildfields-applicationfield "Permanent link")

ApplicationFields contained within this Application.

### applicationOwnedAssets  ([Asset](../asset/))[¶](#applicationownedassets-asset "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/application/) to provide us with more information. 

Back to top

[Previous App](../../app/) [Next ApplicationField](../applicationfield/) 
