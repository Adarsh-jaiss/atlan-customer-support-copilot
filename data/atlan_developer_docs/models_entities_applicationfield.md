# Source URL
https://developer.atlan.com/models/entities/applicationfield/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/applicationfield/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/applicationfield.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ApplicationField - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/applicationfield/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/applicationfield.png
meta-twitter:title: ApplicationField - Developer
meta-viewport: width=device-width,initial-scale=1
title: ApplicationField - Developer
-->

[Skip to content](#applicationfield) Developer ApplicationField Initializing search 
...
This is a complete reference for the `ApplicationField` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ApplicationField` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class ApplicationField
    link ApplicationField "../applicationfield"
    class App {
        <<abstract>>
    }
    link App "../app"
...
These attributes are inherited from `ApplicationField`'s supertypes (shown above):
...
These attributes are specific to instances of `ApplicationField` (and all of its subtypes).

### applicationParentQualifiedName [¶](#applicationparentqualifiedname "Permanent link")
...
These relationships are inherited from `ApplicationField`'s supertypes:
...
### applicationField  ([ApplicationField](./))[¶](#applicationfield-applicationfield "Permanent link")
...
These relationships are specific to instances of `ApplicationField` (and all of its subtypes).

### applicationFieldOwnedAssets  ([Asset](../asset/))[¶](#applicationfieldownedassets-asset "Permanent link")

Assets contained within this ApplicationField.

### applicationParent  ([Application](../application/))[¶](#applicationparent-application "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/applicationfield/) to provide us with more information. 

Back to top

[Previous Application](../application/) [Next Microsoft Azure](../../azure/) 
