# Source URL
https://developer.atlan.com/models/entities/atlasglossarycategory/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/atlasglossarycategory/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/atlasglossarycategory.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AtlasGlossaryCategory - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/atlasglossarycategory/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/atlasglossarycategory.png
meta-twitter:title: AtlasGlossaryCategory - Developer
meta-viewport: width=device-width,initial-scale=1
title: AtlasGlossaryCategory - Developer
-->

[Skip to content](#atlasglossarycategory) Developer AtlasGlossaryCategory Initializing search 
...
AtlasGlossaryCategory[¶](#atlasglossarycategory "Permanent link")
=================================================================
...
This is a complete reference for the `AtlasGlossaryCategory` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AtlasGlossaryCategory` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AtlasGlossaryCategory
    link AtlasGlossaryCategory "../atlasglossarycategory"
    class Asset {
        <<abstract>>
    }
    link Asset "../asset"
...
These attributes are inherited from `AtlasGlossaryCategory`'s supertypes (shown above):
...
These attributes are specific to instances of `AtlasGlossaryCategory` (and all of its subtypes).

### additionalAttributes [¶](#additionalattributes "Permanent link")

TBC

### categoryType [¶](#categorytype "Permanent link")
...
These relationships are inherited from `AtlasGlossaryCategory`'s supertypes:
...
These relationships are specific to instances of `AtlasGlossaryCategory` (and all of its subtypes).

### anchor  ([AtlasGlossary](../atlasglossary/))[¶](#anchor-atlasglossary "Permanent link")

TBC

### childrenCategories  ([AtlasGlossaryCategory](./))[¶](#childrencategories-atlasglossarycategory "Permanent link")

TBC

### parentCategory  ([AtlasGlossaryCategory](./))[¶](#parentcategory-atlasglossarycategory "Permanent link")

TBC

### terms  ([AtlasGlossaryTerm](../atlasglossaryterm/))[¶](#terms-atlasglossaryterm "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/atlasglossarycategory/) to provide us with more information. 

Back to top

[Previous AtlasGlossary](../atlasglossary/) [Next AtlasGlossaryTerm](../atlasglossaryterm/) 
