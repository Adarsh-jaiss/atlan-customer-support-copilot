# Source URL
https://developer.atlan.com/models/entities/atlasglossaryterm/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/atlasglossaryterm/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/atlasglossaryterm.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AtlasGlossaryTerm - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/atlasglossaryterm/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/atlasglossaryterm.png
meta-twitter:title: AtlasGlossaryTerm - Developer
meta-viewport: width=device-width,initial-scale=1
title: AtlasGlossaryTerm - Developer
-->

[Skip to content](#atlasglossaryterm) Developer AtlasGlossaryTerm Initializing search 
...
This is a complete reference for the `AtlasGlossaryTerm` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AtlasGlossaryTerm` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `AtlasGlossaryTerm`'s supertypes (shown above):
...
These attributes are specific to instances of `AtlasGlossaryTerm` (and all of its subtypes).

### abbreviation [¶](#abbreviation "Permanent link")

TBC

### additionalAttributes [¶](#additionalattributes "Permanent link")
...
### longDescription [¶](#longdescription "Permanent link")

TBC

### shortDescription [¶](#shortdescription "Permanent link")

TBC

### termType [¶](#termtype "Permanent link")
...
These relationships are inherited from `AtlasGlossaryTerm`'s supertypes:
...
### meanings  ([AtlasGlossaryTerm](./))[¶](#meanings-atlasglossaryterm "Permanent link")
...
These relationships are specific to instances of `AtlasGlossaryTerm` (and all of its subtypes).

### anchor  ([AtlasGlossary](../atlasglossary/))[¶](#anchor-atlasglossary "Permanent link")

TBC

### antonyms  ([AtlasGlossaryTerm](./))[¶](#antonyms-atlasglossaryterm "Permanent link")

TBC

### assignedEntities  ([Referenceable](../referenceable/))[¶](#assignedentities-referenceable "Permanent link")

TBC

### categories  ([AtlasGlossaryCategory](../atlasglossarycategory/))[¶](#categories-atlasglossarycategory "Permanent link")

TBC

### classifies  ([AtlasGlossaryTerm](./))[¶](#classifies-atlasglossaryterm "Permanent link")

TBC

### isA  ([AtlasGlossaryTerm](./))[¶](#isa-atlasglossaryterm "Permanent link")

TBC

### preferredTerms  ([AtlasGlossaryTerm](./))[¶](#preferredterms-atlasglossaryterm "Permanent link")

TBC

### preferredToTerms  ([AtlasGlossaryTerm](./))[¶](#preferredtoterms-atlasglossaryterm "Permanent link")

TBC

### replacedBy  ([AtlasGlossaryTerm](./))[¶](#replacedby-atlasglossaryterm "Permanent link")

TBC

### replacementTerms  ([AtlasGlossaryTerm](./))[¶](#replacementterms-atlasglossaryterm "Permanent link")

TBC

### seeAlso  ([AtlasGlossaryTerm](./))[¶](#seealso-atlasglossaryterm "Permanent link")

TBC

### synonyms  ([AtlasGlossaryTerm](./))[¶](#synonyms-atlasglossaryterm "Permanent link")

TBC

### translatedTerms  ([AtlasGlossaryTerm](./))[¶](#translatedterms-atlasglossaryterm "Permanent link")

TBC

### translationTerms  ([AtlasGlossaryTerm](./))[¶](#translationterms-atlasglossaryterm "Permanent link")

TBC

### validValues  ([AtlasGlossaryTerm](./))[¶](#validvalues-atlasglossaryterm "Permanent link")

TBC

### validValuesFor  ([AtlasGlossaryTerm](./))[¶](#validvaluesfor-atlasglossaryterm "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/atlasglossaryterm/) to provide us with more information. 

Back to top

[Previous AtlasGlossaryCategory](../atlasglossarycategory/) [Next DataMesh](../../datamesh/) 
