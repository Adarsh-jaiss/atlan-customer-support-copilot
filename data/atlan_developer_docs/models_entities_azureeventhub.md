# Source URL
https://developer.atlan.com/models/entities/azureeventhub/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/azureeventhub/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/azureeventhub.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: AzureEventHub - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/azureeventhub/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/azureeventhub.png
meta-twitter:title: AzureEventHub - Developer
meta-viewport: width=device-width,initial-scale=1
title: AzureEventHub - Developer
-->

[Skip to content](#azureeventhub) Developer AzureEventHub Initializing search 
...
This is a complete reference for the `AzureEventHub` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`AzureEventHub` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class AzureEventHub
    link AzureEventHub "../azureeventhub"
    class KafkaTopic
    link KafkaTopic "../kafkatopic"
...
These attributes are inherited from `AzureEventHub`'s supertypes (shown above):
...
### kafkaTopicCleanupPolicy [¶](#kafkatopiccleanuppolicy "Permanent link")

Cleanup policy for this topic.

### kafkaTopicCompressionType [¶](#kafkatopiccompressiontype "Permanent link")

Type of compression used for this topic.

### kafkaTopicIsInternal [¶](#kafkatopicisinternal "Permanent link")

Whether this topic is an internal topic (true) or not (false).

### kafkaTopicLogCleanupPolicy [¶](#kafkatopiclogcleanuppolicy "Permanent link")

Comma seperated Cleanup policy for this topic.

### kafkaTopicPartitionsCount [¶](#kafkatopicpartitionscount "Permanent link")

Number of partitions for this topic.

### kafkaTopicRecordCount [¶](#kafkatopicrecordcount "Permanent link")

Number of (unexpired) messages in this topic.

### kafkaTopicReplicationFactor [¶](#kafkatopicreplicationfactor "Permanent link")

Replication factor for this topic.

### kafkaTopicRetentionTimeInMs [¶](#kafkatopicretentiontimeinms "Permanent link")

Amount of time messages will be retained in this topic, in milliseconds.

### kafkaTopicSegmentBytes [¶](#kafkatopicsegmentbytes "Permanent link")

Segment size for this topic.

### kafkaTopicSizeInBytes [¶](#kafkatopicsizeinbytes "Permanent link")

Size of this topic, in bytes.

These attributes are specific to instances of `AzureEventHub` (and all of its subtypes).

### azureEventHubStatus [¶](#azureeventhubstatus "Permanent link")
...
These relationships are inherited from `AzureEventHub`'s supertypes:
...
### kafkaConsumerGroups  ([KafkaConsumerGroup](../kafkaconsumergroup/))[¶](#kafkaconsumergroups-kafkaconsumergroup "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/azureeventhub/) to provide us with more information. 

Back to top

[Previous ADLSObject](../adlsobject/) [Next AzureEventHubConsumerGroup](../azureeventhubconsumergroup/) 
