# Source URL
https://developer.atlan.com/models/entities/businesspolicy/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/businesspolicy/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/businesspolicy.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: BusinessPolicy - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/businesspolicy/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/businesspolicy.png
meta-twitter:title: BusinessPolicy - Developer
meta-viewport: width=device-width,initial-scale=1
title: BusinessPolicy - Developer
-->

[Skip to content](#businesspolicy) Developer BusinessPolicy Initializing search 
...
BusinessPolicy[¶](#businesspolicy "Permanent link")
===================================================
...
This is a complete reference for the `BusinessPolicy` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`BusinessPolicy` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class BusinessPolicy
    link BusinessPolicy "../businesspolicy"
    class Asset {
        <<abstract>>
    }
    link Asset "../asset"
...
These attributes are inherited from `BusinessPolicy`'s supertypes (shown above):
...
These attributes are specific to instances of `BusinessPolicy` (and all of its subtypes).

### businessPolicyBaseParentGuid [¶](#businesspolicybaseparentguid "Permanent link")

Base parent Guid for policy used in version

### businessPolicyFilterDSL [¶](#businesspolicyfilterdsl "Permanent link")

Business Policy Filter ES DSL to denote the associate asset/s involved.

### businessPolicyLongDescription [¶](#businesspolicylongdescription "Permanent link")

Body of the business policy, a long readme like document

### businessPolicyReviewPeriod [¶](#businesspolicyreviewperiod "Permanent link")

Duration for the business policy to complete review.

### businessPolicyRules [¶](#businesspolicyrules "Permanent link")

List of rules applied to this business policy.

### businessPolicySelectedApprovalWF [¶](#businesspolicyselectedapprovalwf "Permanent link")

Selected approval workflow id for business policy

### businessPolicyType [¶](#businesspolicytype "Permanent link")

Type of business policy

### businessPolicyValidFrom [¶](#businesspolicyvalidfrom "Permanent link")

Validity start date of the policy

### businessPolicyValidTill [¶](#businesspolicyvalidtill "Permanent link")

Validity end date of the policy

### businessPolicyVersion [¶](#businesspolicyversion "Permanent link")
...
These relationships are inherited from `BusinessPolicy`'s supertypes:
...
These relationships are specific to instances of `BusinessPolicy` (and all of its subtypes).

### exceptionsForBusinessPolicy  ([BusinessPolicyException](../businesspolicyexception/))[¶](#exceptionsforbusinesspolicy-businesspolicyexception "Permanent link")

Exception assigned to business polices

### relatedBusinessPolicies  ([BusinessPolicy](./))[¶](#relatedbusinesspolicies-businesspolicy "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/businesspolicy/) to provide us with more information. 

Back to top

[Previous AuthService](../authservice/) [Next BusinessPolicyException](../businesspolicyexception/) 
