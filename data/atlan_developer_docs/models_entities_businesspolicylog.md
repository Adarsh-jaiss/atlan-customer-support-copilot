# Source URL
https://developer.atlan.com/models/entities/businesspolicylog/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/businesspolicylog/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/businesspolicylog.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: BusinessPolicyLog - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/businesspolicylog/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/businesspolicylog.png
meta-twitter:title: BusinessPolicyLog - Developer
meta-viewport: width=device-width,initial-scale=1
title: BusinessPolicyLog - Developer
-->

[Skip to content](#businesspolicylog) Developer BusinessPolicyLog Initializing search 
...
BusinessPolicyLog[¶](#businesspolicylog "Permanent link")
=========================================================
...
This is a complete reference for the `BusinessPolicyLog` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`BusinessPolicyLog` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class BusinessPolicyLog
    link BusinessPolicyLog "../businesspolicylog"
    class Asset {
        <<abstract>>
    }
    link Asset "../asset"
...
These attributes are inherited from `BusinessPolicyLog`'s supertypes (shown above):
...
These attributes are specific to instances of `BusinessPolicyLog` (and all of its subtypes).

### businessPolicyId [¶](#businesspolicyid "Permanent link")

business policy guid for which log are created

### businessPolicyLogPolicyType [¶](#businesspolicylogpolicytype "Permanent link")

business policy type for which log are created

### compliantAssetsCount [¶](#compliantassetscount "Permanent link")

number of compliant assets in the policy

### governedAssetsCount [¶](#governedassetscount "Permanent link")

number of governed assets in the policy

### nonCompliantAssetsCount [¶](#noncompliantassetscount "Permanent link")

number of non compliant assets in the policy

### nonGovernedAssetsCount [¶](#nongovernedassetscount "Permanent link")
...
These relationships are inherited from `BusinessPolicyLog`'s supertypes:
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/businesspolicylog/) to provide us with more information. 

Back to top

[Previous BusinessPolicyIncident](../businesspolicyincident/) [Next Incident](../incident/) 
