# Source URL
https://developer.atlan.com/models/entities/cogniteevent/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/cogniteevent/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/cogniteevent.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CogniteEvent - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/cogniteevent/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/cogniteevent.png
meta-twitter:title: CogniteEvent - Developer
meta-viewport: width=device-width,initial-scale=1
title: CogniteEvent - Developer
-->

[Skip to content](#cogniteevent) Developer CogniteEvent Initializing search 
...
CogniteEvent[¶](#cogniteevent "Permanent link")
===============================================
...
This is a complete reference for the `CogniteEvent` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CogniteEvent` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CogniteEvent
    link CogniteEvent "../cogniteevent"
    class Cognite {
        <<abstract>>
    }
...
These attributes are inherited from `CogniteEvent`'s supertypes (shown above):
...
These relationships are inherited from `CogniteEvent`'s supertypes:
...
These relationships are specific to instances of `CogniteEvent` (and all of its subtypes).
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/cogniteevent/) to provide us with more information. 

Back to top

[Previous CogniteAsset](../cogniteasset/) [Next CogniteFile](../cognitefile/) 
