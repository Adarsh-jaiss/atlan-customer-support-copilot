# Source URL
https://developer.atlan.com/models/entities/cognosfolder/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/cognosfolder/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/cognosfolder.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CognosFolder - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/cognosfolder/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/cognosfolder.png
meta-twitter:title: CognosFolder - Developer
meta-viewport: width=device-width,initial-scale=1
title: CognosFolder - Developer
-->

[Skip to content](#cognosfolder) Developer CognosFolder Initializing search 
...
CognosFolder[¶](#cognosfolder "Permanent link")
===============================================
...
This is a complete reference for the `CognosFolder` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CognosFolder` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CognosFolder
    link CognosFolder "../cognosfolder"
    class Cognos {
        <<abstract>>
    }
    link Cognos "../cognos"
...
These attributes are inherited from `CognosFolder`'s supertypes (shown above):
...
These attributes are specific to instances of `CognosFolder` (and all of its subtypes).

### cognosFolderChildObjectsCount [¶](#cognosfolderchildobjectscount "Permanent link")

Number of children in the folder (excluding subfolders).

### cognosFolderSubFolderCount [¶](#cognosfoldersubfoldercount "Permanent link")
...
These relationships are inherited from `CognosFolder`'s supertypes:
...
These relationships are specific to instances of `CognosFolder` (and all of its subtypes).

### cognosDashboards  ([CognosDashboard](../cognosdashboard/))[¶](#cognosdashboards-cognosdashboard "Permanent link")

TBC

### cognosExplorations  ([CognosExploration](../cognosexploration/))[¶](#cognosexplorations-cognosexploration "Permanent link")

TBC

### cognosFiles  ([CognosFile](../cognosfile/))[¶](#cognosfiles-cognosfile "Permanent link")

TBC

### cognosFolder  ([CognosFolder](./))[¶](#cognosfolder-cognosfolder "Permanent link")

TBC

### cognosModules  ([CognosModule](../cognosmodule/))[¶](#cognosmodules-cognosmodule "Permanent link")

TBC

### cognosPackages  ([CognosPackage](../cognospackage/))[¶](#cognospackages-cognospackage "Permanent link")

TBC

### cognosReports  ([CognosReport](../cognosreport/))[¶](#cognosreports-cognosreport "Permanent link")

TBC

### cognosSubFolders  ([CognosFolder](./))[¶](#cognossubfolders-cognosfolder "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/cognosfolder/) to provide us with more information. 

Back to top

[Previous CognosFile](../cognosfile/) [Next CognosModule](../cognosmodule/) 
