# Source URL
https://developer.atlan.com/models/entities/cognospackage/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/cognospackage/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/cognospackage.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CognosPackage - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/cognospackage/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/cognospackage.png
meta-twitter:title: CognosPackage - Developer
meta-viewport: width=device-width,initial-scale=1
title: CognosPackage - Developer
-->

[Skip to content](#cognospackage) Developer CognosPackage Initializing search 
...
CognosPackage[¶](#cognospackage "Permanent link")
=================================================
...
This is a complete reference for the `CognosPackage` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CognosPackage` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CognosPackage
    link CognosPackage "../cognospackage"
    class Cognos {
        <<abstract>>
    }
    link Cognos "../cognos"
...
These attributes are inherited from `CognosPackage`'s supertypes (shown above):
...
These relationships are inherited from `CognosPackage`'s supertypes:
...
These relationships are specific to instances of `CognosPackage` (and all of its subtypes).
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/cognospackage/) to provide us with more information. 

Back to top

[Previous CognosModule](../cognosmodule/) [Next CognosReport](../cognosreport/) 
