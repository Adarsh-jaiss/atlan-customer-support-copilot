# Source URL
https://developer.atlan.com/models/entities/column/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/column/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/column.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Column - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/column/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/column.png
meta-twitter:title: Column - Developer
meta-viewport: width=device-width,initial-scale=1
title: Column - Developer
-->

[Skip to content](#column) Developer Column Initializing search 
...
This is a complete reference for the `Column` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`Column` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `Column`'s supertypes (shown above):
...
### databaseQualifiedName [¶](#databasequalifiedname "Permanent link")
...
### viewName [¶](#viewname "Permanent link")
...
These attributes are specific to instances of `Column` (and all of its subtypes).

### columnAverage [¶](#columnaverage "Permanent link")

Average value in this column.

### columnAverageLength [¶](#columnaveragelength "Permanent link")

Average length of values in a string column.

### columnDepthLevel [¶](#columndepthlevel "Permanent link")

Level of nesting of this column, used for STRUCT and NESTED columns.

### columnDistinctValuesCount [¶](#columndistinctvaluescount "Permanent link")

Number of rows that contain distinct values.

### columnDistinctValuesCountLong [¶](#columndistinctvaluescountlong "Permanent link")

Number of rows that contain distinct values.

### columnDuplicateValuesCount [¶](#columnduplicatevaluescount "Permanent link")

Number of rows that contain duplicate values.

### columnDuplicateValuesCountLong [¶](#columnduplicatevaluescountlong "Permanent link")

Number of rows that contain duplicate values.

### columnHierarchy [¶](#columnhierarchy "Permanent link")

List of top\-level upstream nested columns.

### columnHistogram [¶](#columnhistogram "Permanent link")

List of values in a histogram that represents the contents of this column.

### columnMax [¶](#columnmax "Permanent link")

Greatest value in a numeric column.

### columnMaximumStringLength [¶](#columnmaximumstringlength "Permanent link")

Length of the longest value in a string column.

### columnMaxs [¶](#columnmaxs "Permanent link")

List of the greatest values in a column.

### columnMean [¶](#columnmean "Permanent link")

Arithmetic mean of the values in a numeric column.

### columnMedian [¶](#columnmedian "Permanent link")

Calculated median of the values in a numeric column.

### columnMin [¶](#columnmin "Permanent link")

Least value in a numeric column.

### columnMinimumStringLength [¶](#columnminimumstringlength "Permanent link")

Length of the shortest value in a string column.

### columnMins [¶](#columnmins "Permanent link")

List of the least values in a column.

### columnMissingValuesCount [¶](#columnmissingvaluescount "Permanent link")

Number of rows in a column that do not contain content.

### columnMissingValuesCountLong [¶](#columnmissingvaluescountlong "Permanent link")

Number of rows in a column that do not contain content.

### columnMissingValuesPercentage [¶](#columnmissingvaluespercentage "Permanent link")

Percentage of rows in a column that do not contain content.

### columnStandardDeviation [¶](#columnstandarddeviation "Permanent link")

Calculated standard deviation of the values in a numeric column.

### columnSum [¶](#columnsum "Permanent link")

Calculated sum of the values in a numeric column.

### columnTopValues [¶](#columntopvalues "Permanent link")

List of top values in this column.

### columnUniqueValuesCount [¶](#columnuniquevaluescount "Permanent link")

Number of rows in which a value in this column appears only once.

### columnUniqueValuesCountLong [¶](#columnuniquevaluescountlong "Permanent link")

Number of rows in which a value in this column appears only once.

### columnUniquenessPercentage [¶](#columnuniquenesspercentage "Permanent link")
...
### columnVariance [¶](#columnvariance "Permanent link")
...
### defaultValue [¶](#defaultvalue "Permanent link")

Default value for this column.

### isClustered [¶](#isclustered "Permanent link")

Whether this column is a clustered column (true) or not (false).

### isDist [¶](#isdist "Permanent link")

Whether this column is a distribution column (true) or not (false).

### isForeign [¶](#isforeign "Permanent link")
...
### nosqlCollectionQualifiedName [¶](#nosqlcollectionqualifiedname "Permanent link")
...
These relationships are inherited from `Column`'s supertypes:
...
These relationships are specific to instances of `Column` (and all of its subtypes).

### calculationView  ([CalculationView](../calculationview/))[¶](#calculationview-calculationview "Permanent link")

Calculate view in which this column exists.

### columnDbtModelColumns  ([DbtModelColumn](../dbtmodelcolumn/))[¶](#columndbtmodelcolumns-dbtmodelcolumn "Permanent link")

TBC

### cosmosMongoDBCollection  ([CosmosMongoDBCollection](../cosmosmongodbcollection/))[¶](#cosmosmongodbcollection-cosmosmongodbcollection "Permanent link")

Cosmos collection in which this column exists.

### dataQualityMetricDimensions  ([Metric](../metric/))[¶](#dataqualitymetricdimensions-metric "Permanent link")

TBC

### dbtMetrics  ([DbtMetric](../dbtmetric/))[¶](#dbtmetrics-dbtmetric "Permanent link")

TBC

### dbtModelColumns  ([DbtModelColumn](../dbtmodelcolumn/))[¶](#dbtmodelcolumns-dbtmodelcolumn "Permanent link")

TBC

### foreignKeyFrom  ([Column](./))[¶](#foreignkeyfrom-column "Permanent link")

Column this foreign key column refers to.

### foreignKeyTo  ([Column](./))[¶](#foreignkeyto-column "Permanent link")

Columns that use this column as a foreign key.

### materialisedView  ([MaterialisedView](../materialisedview/))[¶](#materialisedview-materialisedview "Permanent link")

Materialized view in which this column exists. (1\)
...
### metricTimestamps  ([Metric](../metric/))[¶](#metrictimestamps-metric "Permanent link")

TBC

### nestedColumns  ([Column](./))[¶](#nestedcolumns-column "Permanent link")

Nested columns that exist within this column.

### parentColumn  ([Column](./))[¶](#parentcolumn-column "Permanent link")

Column in which this sub\-column is nested.

### queries  ([Query](../query/))[¶](#queries-query "Permanent link")

Queries that access this column.

### snowflakeDynamicTable  ([SnowflakeDynamicTable](../snowflakedynamictable/))[¶](#snowflakedynamictable-snowflakedynamictable "Permanent link")

Snowflake dynamic table in which this column exists.

### table  ([Table](../table/))[¶](#table-table "Permanent link")

Table in which this column exists.

### tablePartition  ([TablePartition](../tablepartition/))[¶](#tablepartition-tablepartition "Permanent link")

Table partition that contains this column.

### view  ([View](../view/))[¶](#view-view "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/column/) to provide us with more information. 

Back to top

[Previous MaterialisedView](../materialisedview/) [Next Query](../query/) 
