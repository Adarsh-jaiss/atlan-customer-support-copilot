# Source URL
https://developer.atlan.com/models/entities/cosmosmongodbaccount/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/cosmosmongodbaccount/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/cosmosmongodbaccount.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CosmosMongoDBAccount - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/cosmosmongodbaccount/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/cosmosmongodbaccount.png
meta-twitter:title: CosmosMongoDBAccount - Developer
meta-viewport: width=device-width,initial-scale=1
title: CosmosMongoDBAccount - Developer
-->

[Skip to content](#cosmosmongodbaccount) Developer CosmosMongoDBAccount Initializing search 
...
CosmosMongoDBAccount[¶](#cosmosmongodbaccount "Permanent link")
===============================================================
...
This is a complete reference for the `CosmosMongoDBAccount` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CosmosMongoDBAccount` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CosmosMongoDBAccount
    link CosmosMongoDBAccount "../cosmosmongodbaccount"
    class CosmosMongoDB {
        <<abstract>>
    }
...
These attributes are inherited from `CosmosMongoDBAccount`'s supertypes (shown above):
...
These attributes are specific to instances of `CosmosMongoDBAccount` (and all of its subtypes).

### cosmosMongoDBAccountConsistencyPolicy [¶](#cosmosmongodbaccountconsistencypolicy "Permanent link")

The consistency policy configured for the Cosmos MongoDB account.

### cosmosMongoDBAccountDocumentEndpoint [¶](#cosmosmongodbaccountdocumentendpoint "Permanent link")

The Document Endpoint URL for the Cosmos MongoDB account.

### cosmosMongoDBAccountEnableAutomaticFailover [¶](#cosmosmongodbaccountenableautomaticfailover "Permanent link")

Indicates whether automatic failover is enabled for the Cosmos MongoDB account.

### cosmosMongoDBAccountEnableMultipleWriteLocations [¶](#cosmosmongodbaccountenablemultiplewritelocations "Permanent link")

Indicates whether multiple write locations are enabled for the Cosmos MongoDB account.

### cosmosMongoDBAccountEnablePartitionKeyMonitor [¶](#cosmosmongodbaccountenablepartitionkeymonitor "Permanent link")

Indicates whether partition key monitoring is enabled for the Cosmos MongoDB account.

### cosmosMongoDBAccountInstanceId [¶](#cosmosmongodbaccountinstanceid "Permanent link")

The unique identifier for the Cosmos MongoDB account.

### cosmosMongoDBAccountIsVirtualNetworkFilterEnabled [¶](#cosmosmongodbaccountisvirtualnetworkfilterenabled "Permanent link")

Indicates whether the virtual network filter is enabled for the Cosmos MongoDB account.

### cosmosMongoDBAccountLocations [¶](#cosmosmongodbaccountlocations "Permanent link")

The locations where the Cosmos MongoDB account is available.

### cosmosMongoDBAccountMongoEndpoint [¶](#cosmosmongodbaccountmongoendpoint "Permanent link")

The MongoDB connection endpoint for the Cosmos MongoDB account.

### cosmosMongoDBAccountPublicNetworkAccess [¶](#cosmosmongodbaccountpublicnetworkaccess "Permanent link")

The status of public network access for the Cosmos MongoDB account.

### cosmosMongoDBAccountReadLocations [¶](#cosmosmongodbaccountreadlocations "Permanent link")

The read locations configured for the Cosmos MongoDB account.

### cosmosMongoDBAccountResourceGroup [¶](#cosmosmongodbaccountresourcegroup "Permanent link")

The resource group that contains the Cosmos MongoDB account.

### cosmosMongoDBAccountSubscriptionId [¶](#cosmosmongodbaccountsubscriptionid "Permanent link")

The ID of the subscription to which the Cosmos MongoDB account belongs.

### cosmosMongoDBAccountType [¶](#cosmosmongodbaccounttype "Permanent link")

The type of the Cosmos MongoDB account, such as RU or VCORE.

### cosmosMongoDBAccountWriteLocations [¶](#cosmosmongodbaccountwritelocations "Permanent link")

The write locations configured for the Cosmos MongoDB account.

### cosmosMongoDBDatabaseCount [¶](#cosmosmongodbdatabasecount "Permanent link")
...
These relationships are inherited from `CosmosMongoDBAccount`'s supertypes:
...
These relationships are specific to instances of `CosmosMongoDBAccount` (and all of its subtypes).

### cosmosMongoDBDatabases  ([CosmosMongoDBDatabase](../cosmosmongodbdatabase/))[¶](#cosmosmongodbdatabases-cosmosmongodbdatabase "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/cosmosmongodbaccount/) to provide us with more information. 

Back to top

[Previous CosmosMongoDB](../../cosmosmongodb/) [Next CosmosMongoDBCollection](../cosmosmongodbcollection/) 
