# Source URL
https://developer.atlan.com/models/entities/cosmosmongodbcollection/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/cosmosmongodbcollection/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/cosmosmongodbcollection.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CosmosMongoDBCollection - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/cosmosmongodbcollection/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/cosmosmongodbcollection.png
meta-twitter:title: CosmosMongoDBCollection - Developer
meta-viewport: width=device-width,initial-scale=1
title: CosmosMongoDBCollection - Developer
-->

[Skip to content](#cosmosmongodbcollection) Developer CosmosMongoDBCollection Initializing search 
...
CosmosMongoDBCollection[¶](#cosmosmongodbcollection "Permanent link")
=====================================================================
...
This is a complete reference for the `CosmosMongoDBCollection` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CosmosMongoDBCollection` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CosmosMongoDBCollection
    link CosmosMongoDBCollection "../cosmosmongodbcollection"
    class CosmosMongoDB {
        <<abstract>>
    }
    ...
    link MongoDBCollection "../mongodbcollection"
...
These attributes are inherited from `CosmosMongoDBCollection`'s supertypes (shown above):
...
### columnCount [¶](#columncount "Permanent link")

Number of columns in this table.

### externalLocation [¶](#externallocation "Permanent link")

External location of this table, for example: an S3 object location.

### externalLocationFormat [¶](#externallocationformat "Permanent link")

Format of the external location of this table, for example: JSON, CSV, PARQUET, etc.

### externalLocationRegion [¶](#externallocationregion "Permanent link")

Region of the external location of this table, for example: S3 region.

### icebergCatalogName [¶](#icebergcatalogname "Permanent link")

iceberg table catalog name (can be any user defined name)

### icebergCatalogSource [¶](#icebergcatalogsource "Permanent link")

iceberg table catalog type (glue, polaris, snowflake)

### icebergCatalogTableName [¶](#icebergcatalogtablename "Permanent link")

catalog table name (actual table name on the catalog side).

### icebergCatalogTableNamespace [¶](#icebergcatalogtablenamespace "Permanent link")

catalog table namespace (actual database name on the catalog side).

### icebergTableBaseLocation [¶](#icebergtablebaselocation "Permanent link")

iceberg table base location inside the external volume.

### icebergTableType [¶](#icebergtabletype "Permanent link")

iceberg table type (managed vs unmanaged)

### isPartitioned [¶](#ispartitioned "Permanent link")

Whether this table is partitioned (true) or not (false).

### isQueryPreview [¶](#isquerypreview "Permanent link")

Whether preview queries are allowed for this table (true) or not (false).

### isSharded [¶](#issharded "Permanent link")

Whether this table is a sharded table (true) or not (false).

### isTemporary [¶](#istemporary "Permanent link")

Whether this table is temporary (true) or not (false).

### partitionCount [¶](#partitioncount "Permanent link")

Number of partitions in this table.

### partitionList [¶](#partitionlist "Permanent link")

List of partitions in this table.

### partitionStrategy [¶](#partitionstrategy "Permanent link")
...
### rowCount [¶](#rowcount "Permanent link")

Number of rows in this table.

### sizeBytes [¶](#sizebytes "Permanent link")

Size of this table, in bytes.

### tableExternalVolumeName [¶](#tableexternalvolumename "Permanent link")

external volume name for the table.

### tableRetentionTime [¶](#tableretentiontime "Permanent link")

Data retention time in days.

### tableType [¶](#tabletype "Permanent link")
...
### noSQLSchemaDefinition [¶](#nosqlschemadefinition "Permanent link")

Represents attributes for describing the key schema for the table and indexes.

### mongoDBCollectionAverageObjectSize [¶](#mongodbcollectionaverageobjectsize "Permanent link")

Average size of an object in the collection.

### mongoDBCollectionExpireAfterSeconds [¶](#mongodbcollectionexpireafterseconds "Permanent link")

Seconds after which documents in a time series collection or clustered collection expire.

### mongoDBCollectionIsCapped [¶](#mongodbcollectioniscapped "Permanent link")

Whether the collection is capped (true) or not (false).

### mongoDBCollectionMaxSize [¶](#mongodbcollectionmaxsize "Permanent link")

Maximum size allowed in a capped collection.

### mongoDBCollectionMaximumDocumentCount [¶](#mongodbcollectionmaximumdocumentcount "Permanent link")

Maximum number of documents allowed in a capped collection.

### mongoDBCollectionNumIndexes [¶](#mongodbcollectionnumindexes "Permanent link")

Number of indexes on the collection.

### mongoDBCollectionNumOrphanDocs [¶](#mongodbcollectionnumorphandocs "Permanent link")

Number of orphaned documents in the collection.

### mongoDBCollectionSchemaDefinition [¶](#mongodbcollectionschemadefinition "Permanent link")

Definition of the schema applicable for the collection.

### mongoDBCollectionSubtype [¶](#mongodbcollectionsubtype "Permanent link")

Subtype of a MongoDB collection, for example: Capped, Time Series, etc.

### mongoDBCollectionTimeField [¶](#mongodbcollectiontimefield "Permanent link")

Name of the field containing the date in each time series document.

### mongoDBCollectionTimeGranularity [¶](#mongodbcollectiontimegranularity "Permanent link")

Closest match to the time span between consecutive incoming measurements.

### mongoDBCollectionTotalIndexSize [¶](#mongodbcollectiontotalindexsize "Permanent link")

Total size of all indexes.

These attributes are specific to instances of `CosmosMongoDBCollection` (and all of its subtypes).

### cosmosMongoDBDatabaseQualifiedName [¶](#cosmosmongodbdatabasequalifiedname "Permanent link")
...
These relationships are inherited from `CosmosMongoDBCollection`'s supertypes:
...
### columns  ([Column](../column/))[¶](#columns-column "Permanent link")

Columns that exist within this table.

### dimensions  ([Table](../table/))[¶](#dimensions-table "Permanent link")

TBC

### facts  ([Table](../table/))[¶](#facts-table "Permanent link")

TBC

### partitions  ([TablePartition](../tablepartition/))[¶](#partitions-tablepartition "Permanent link")
...
### atlanSchema  ([Schema](../schema/))[¶](#atlanschema-schema "Permanent link")

Schema in which this table exists. (1\)
...
### mongoDBDatabase  ([MongoDBDatabase](../mongodbdatabase/))[¶](#mongodbdatabase-mongodbdatabase "Permanent link")

Database in which the collection exists.

These relationships are specific to instances of `CosmosMongoDBCollection` (and all of its subtypes).

### cosmosMongoDBDatabase  ([CosmosMongoDBDatabase](../cosmosmongodbdatabase/))[¶](#cosmosmongodbdatabase-cosmosmongodbdatabase "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/cosmosmongodbcollection/) to provide us with more information. 

Back to top

[Previous CosmosMongoDBAccount](../cosmosmongodbaccount/) [Next CosmosMongoDBDatabase](../cosmosmongodbdatabase/) 
