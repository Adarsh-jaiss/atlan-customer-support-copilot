# Source URL
https://developer.atlan.com/models/entities/cubefield/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/cubefield/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/cubefield.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CubeField - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/cubefield/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/cubefield.png
meta-twitter:title: CubeField - Developer
meta-viewport: width=device-width,initial-scale=1
title: CubeField - Developer
-->

[Skip to content](#cubefield) Developer CubeField Initializing search 
...
This is a complete reference for the `CubeField` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CubeField` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CubeField
    link CubeField "../cubefield"
...
These attributes are inherited from `CubeField`'s supertypes (shown above):
...
These attributes are specific to instances of `CubeField` (and all of its subtypes).

### cubeFieldGeneration [¶](#cubefieldgeneration "Permanent link")

Generation of the field in the cube hierarchy.

### cubeFieldLevel [¶](#cubefieldlevel "Permanent link")

Level of the field in the cube hierarchy.

### cubeFieldMeasureExpression [¶](#cubefieldmeasureexpression "Permanent link")

Expression used to calculate this measure.

### cubeParentFieldName [¶](#cubeparentfieldname "Permanent link")

Name of the parent field in which this field is nested.

### cubeParentFieldQualifiedName [¶](#cubeparentfieldqualifiedname "Permanent link")

Unique name of the parent field in which this field is nested.

### cubeSubFieldCount [¶](#cubesubfieldcount "Permanent link")
...
These relationships are inherited from `CubeField`'s supertypes:
...
These relationships are specific to instances of `CubeField` (and all of its subtypes).

### cubeHierarchy  ([CubeHierarchy](../cubehierarchy/))[¶](#cubehierarchy-cubehierarchy "Permanent link")

Hierarchy in which this field exists.

### cubeNestedFields  ([CubeField](./))[¶](#cubenestedfields-cubefield "Permanent link")

Individual fields nested within this cube field.

### cubeParentField  ([CubeField](./))[¶](#cubeparentfield-cubefield "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/cubefield/) to provide us with more information. 

Back to top

[Previous CubeHierarchy](../cubehierarchy/) [Next API](../../api/) 
