# Source URL
https://developer.atlan.com/models/entities/cubehierarchy/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/cubehierarchy/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/cubehierarchy.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CubeHierarchy - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/cubehierarchy/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/cubehierarchy.png
meta-twitter:title: CubeHierarchy - Developer
meta-viewport: width=device-width,initial-scale=1
title: CubeHierarchy - Developer
-->

[Skip to content](#cubehierarchy) Developer CubeHierarchy Initializing search 
...
This is a complete reference for the `CubeHierarchy` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CubeHierarchy` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CubeHierarchy
    link CubeHierarchy "../cubehierarchy"
...
These attributes are inherited from `CubeHierarchy`'s supertypes (shown above):
...
These attributes are specific to instances of `CubeHierarchy` (and all of its subtypes).

### cubeFieldCount [¶](#cubefieldcount "Permanent link")
...
These relationships are inherited from `CubeHierarchy`'s supertypes:
...
These relationships are specific to instances of `CubeHierarchy` (and all of its subtypes).

### cubeDimension  ([CubeDimension](../cubedimension/))[¶](#cubedimension-cubedimension "Permanent link")

Dimension in which this hierarchy exists.

### cubeFields  ([CubeField](../cubefield/))[¶](#cubefields-cubefield "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/cubehierarchy/) to provide us with more information. 

Back to top

[Previous CubeDimension](../cubedimension/) [Next CubeField](../cubefield/) 
