# Source URL
https://developer.atlan.com/models/entities/customentity/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/customentity/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/customentity.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: CustomEntity - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/customentity/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/customentity.png
meta-twitter:title: CustomEntity - Developer
meta-viewport: width=device-width,initial-scale=1
title: CustomEntity - Developer
-->

[Skip to content](#customentity) Developer CustomEntity Initializing search 
...
CustomEntity[¶](#customentity "Permanent link")
===============================================
...
This is a complete reference for the `CustomEntity` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`CustomEntity` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class CustomEntity
    link CustomEntity "../customentity"
    class Custom {
        <<abstract>>
    }
    link Custom "../custom"
...
These attributes are inherited from `CustomEntity`'s supertypes (shown above):
...
These relationships are inherited from `CustomEntity`'s supertypes:
...
These relationships are specific to instances of `CustomEntity` (and all of its subtypes).

### customChildEntities  ([CustomEntity](./))[¶](#customchildentities-customentity "Permanent link")

Custom entities contained within this entity.

### customParentEntity  ([CustomEntity](./))[¶](#customparententity-customentity "Permanent link")

Custom entity that contains this entity.

### customRelatedFromEntities  ([CustomEntity](./))[¶](#customrelatedfromentities-customentity "Permanent link")

Source custom entity indicating where the relationship originates.

### customRelatedToEntities  ([CustomEntity](./))[¶](#customrelatedtoentities-customentity "Permanent link")

Target custom entity indicating where the relationship is directed.

---

2023\-01\-042025\-01\-14

**Was this page helpful?**

Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/customentity/) to provide us with more information. 

Back to top

[Previous Custom](../../custom/) [Next Dataverse](../../dataverse/) 
