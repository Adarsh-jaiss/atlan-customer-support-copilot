# Source URL
https://developer.atlan.com/models/entities/datacontract/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/datacontract/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/datacontract.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DataContract - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/datacontract/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/datacontract.png
meta-twitter:title: DataContract - Developer
meta-viewport: width=device-width,initial-scale=1
title: DataContract - Developer
-->

[Skip to content](#datacontract) Developer DataContract Initializing search 
...
DataContract[¶](#datacontract "Permanent link")
===============================================
...
This is a complete reference for the `DataContract` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DataContract` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DataContract
    link DataContract "../datacontract"
    class Catalog {
        <<abstract>>
    }
...
These attributes are inherited from `DataContract`'s supertypes (shown above):
...
These attributes are specific to instances of `DataContract` (and all of its subtypes).

### dataContractAssetGuid [¶](#datacontractassetguid "Permanent link")

Unique identifier of the asset associated with this data contract.

### dataContractJson [¶](#datacontractjson "Permanent link")

(Deprecated) Replaced by dataContractSpec attribute.

### dataContractSpec [¶](#datacontractspec "Permanent link")
...
### dataContractVersion [¶](#datacontractversion "Permanent link")
...
These relationships are inherited from `DataContract`'s supertypes:
...
### dataContractLatest  ([DataContract](./))[¶](#datacontractlatest-datacontract "Permanent link")

Latest version of the data contract (in any status) for this asset.

### dataContractLatestCertified  ([DataContract](./))[¶](#datacontractlatestcertified-datacontract "Permanent link")
...
These relationships are specific to instances of `DataContract` (and all of its subtypes).

### dataContractAssetCertified  ([Asset](../asset/))[¶](#datacontractassetcertified-asset "Permanent link")

Asset this contract controls.

### dataContractAssetLatest  ([Asset](../asset/))[¶](#datacontractassetlatest-asset "Permanent link")

Asset this contract controls or will control.

### dataContractNextVersion  ([DataContract](./))[¶](#datacontractnextversion-datacontract "Permanent link")

Data contract instance that holds the next version of this contract.

### dataContractPreviousVersion  ([DataContract](./))[¶](#datacontractpreviousversion-datacontract "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/datacontract/) to provide us with more information. 

Back to top

[Previous DataProduct](../dataproduct/) [Next Stakeholder](../stakeholder/) 
