# Source URL
https://developer.atlan.com/models/entities/dataproduct/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/dataproduct/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/dataproduct.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DataProduct - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/dataproduct/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/dataproduct.png
meta-twitter:title: DataProduct - Developer
meta-viewport: width=device-width,initial-scale=1
title: DataProduct - Developer
-->

[Skip to content](#dataproduct) Developer DataProduct Initializing search 
...
DataProduct[¶](#dataproduct "Permanent link")
=============================================
...
This is a complete reference for the `DataProduct` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DataProduct` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DataProduct
    link DataProduct "../dataproduct"
    class DataMesh {
        <<abstract>>
    }
...
These attributes are inherited from `DataProduct`'s supertypes (shown above):
...
These attributes are specific to instances of `DataProduct` (and all of its subtypes).

### daapCriticality [¶](#daapcriticality "Permanent link")

Criticality of this data product.

### daapInputPortGuids [¶](#daapinputportguids "Permanent link")

Input ports guids for this data product.

### daapOutputPortGuids [¶](#daapoutputportguids "Permanent link")

Output ports guids for this data product.

### daapSensitivity [¶](#daapsensitivity "Permanent link")

Information sensitivity of this data product.

### daapStatus [¶](#daapstatus "Permanent link")

Status of this data product.

### daapVisibility [¶](#daapvisibility "Permanent link")

Visibility of a data product.

### daapVisibilityGroups [¶](#daapvisibilitygroups "Permanent link")

list of groups for product visibility control

### daapVisibilityUsers [¶](#daapvisibilityusers "Permanent link")

list of users for product visibility control

### dataProductAssetsDSL [¶](#dataproductassetsdsl "Permanent link")

Search DSL used to define which assets are part of this data product.

### dataProductAssetsPlaybookFilter [¶](#dataproductassetsplaybookfilter "Permanent link")
...
### dataProductScoreUpdatedAt [¶](#dataproductscoreupdatedat "Permanent link")

Timestamp when the score of this data product was last updated.

### dataProductScoreValue [¶](#dataproductscorevalue "Permanent link")
...
These relationships are inherited from `DataProduct`'s supertypes:
...
### inputPortDataProducts  ([DataProduct](./))[¶](#inputportdataproducts-dataproduct "Permanent link")
...
### outputPortDataProducts  ([DataProduct](./))[¶](#outputportdataproducts-dataproduct "Permanent link")
...
These relationships are specific to instances of `DataProduct` (and all of its subtypes).

### dataDomain  ([DataDomain](../datadomain/))[¶](#datadomain-datadomain "Permanent link")

Data domain in which this data product exists.

### inputPorts  ([Asset](../asset/))[¶](#inputports-asset "Permanent link")

Input ports for this data product.

### outputPorts  ([Asset](../asset/))[¶](#outputports-asset "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/dataproduct/) to provide us with more information. 

Back to top

[Previous DataDomain](../datadomain/) [Next DataContract](../datacontract/) 
