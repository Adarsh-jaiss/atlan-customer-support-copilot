...
<!--
canonical: https://developer.atlan.com/models/entities/dbtcolumnprocess/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/dbtcolumnprocess.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DbtColumnProcess - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/dbtcolumnprocess/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/dbtcolumnprocess.png
meta-twitter:title: DbtColumnProcess - Developer
meta-viewport: width=device-width,initial-scale=1
title: DbtColumnProcess - Developer
-->

[Skip to content](#dbtcolumnprocess) Developer DbtColumnProcess Initializing search 
...
DbtColumnProcess[¶](#dbtcolumnprocess "Permanent link")
=======================================================
...
This is a complete reference for the `DbtColumnProcess` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DbtColumnProcess` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DbtColumnProcess
    link DbtColumnProcess "../dbtcolumnprocess"
    class Dbt {
        <<abstract>>
    }
    link Dbt "../dbt"
    ...
    class ColumnProcess
    link ColumnProcess "../columnprocess"
...
These attributes are inherited from `DbtColumnProcess`'s supertypes (shown above):
...
These attributes are specific to instances of `DbtColumnProcess` (and all of its subtypes).

### dbtColumnProcessJobStatus [¶](#dbtcolumnprocessjobstatus "Permanent link")
...
These relationships are inherited from `DbtColumnProcess`'s supertypes:

### adfActivity  ([AdfActivity](../adfactivity/))[¶](#adfactivity-adfactivity "Permanent link")

TBC

### airflowTasks  ([AirflowTask](../airflowtask/))[¶](#airflowtasks-airflowtask "Permanent link")

TBC

### columnProcesses  ([ColumnProcess](../columnprocess/))[¶](#columnprocesses-columnprocess "Permanent link")

TBC

### fivetranConnector  ([FivetranConnector](../fivetranconnector/))[¶](#fivetranconnector-fivetranconnector "Permanent link")
...
### matillionComponent  ([MatillionComponent](../matillioncomponent/))[¶](#matillioncomponent-matillioncomponent "Permanent link")
...
### powerBIDataflow  ([PowerBIDataflow](../powerbidataflow/))[¶](#powerbidataflow-powerbidataflow "Permanent link")

TBC

### sparkJobs  ([SparkJob](../sparkjob/))[¶](#sparkjobs-sparkjob "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/dbtcolumnprocess/) to provide us with more information. 

Back to top

[Previous Dbt](../../dbt/) [Next DbtMetric](../dbtmetric/) 
