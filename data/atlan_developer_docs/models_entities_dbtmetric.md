# Source URL
https://developer.atlan.com/models/entities/dbtmetric/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/dbtmetric/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/dbtmetric.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DbtMetric - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/dbtmetric/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/dbtmetric.png
meta-twitter:title: DbtMetric - Developer
meta-viewport: width=device-width,initial-scale=1
title: DbtMetric - Developer
-->

[Skip to content](#dbtmetric) Developer DbtMetric Initializing search 
...
DbtMetric[¶](#dbtmetric "Permanent link")
=========================================
...
This is a complete reference for the `DbtMetric` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DbtMetric` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DbtMetric
    link DbtMetric "../dbtmetric"
    class Dbt {
        <<abstract>>
    }
    link Dbt "../dbt"
...
These attributes are inherited from `DbtMetric`'s supertypes (shown above):
...
### metricFilters [¶](#metricfilters "Permanent link")

Filters to be applied to the metric query.

### metricSQL [¶](#metricsql "Permanent link")

SQL query used to compute the metric.

### metricTimeGrains [¶](#metrictimegrains "Permanent link")

List of time grains to be applied to the metric query.

### metricType [¶](#metrictype "Permanent link")
...
These attributes are specific to instances of `DbtMetric` (and all of its subtypes).

### dbtMetricFilters [¶](#dbtmetricfilters "Permanent link")
...
These relationships are inherited from `DbtMetric`'s supertypes:
...
### assets  ([Asset](../asset/))[¶](#assets-asset "Permanent link")

TBC

### metricDimensionColumns  ([Column](../column/))[¶](#metricdimensioncolumns-column "Permanent link")

TBC

### metricTimestampColumn  ([Column](../column/))[¶](#metrictimestampcolumn-column "Permanent link")

TBC

These relationships are specific to instances of `DbtMetric` (and all of its subtypes).

### dbtMetricFilterColumns  ([Column](../column/))[¶](#dbtmetricfiltercolumns-column "Permanent link")

TBC

### dbtModel  ([DbtModel](../dbtmodel/))[¶](#dbtmodel-dbtmodel "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/dbtmetric/) to provide us with more information. 

Back to top

[Previous DbtColumnProcess](../dbtcolumnprocess/) [Next DbtModel](../dbtmodel/) 
