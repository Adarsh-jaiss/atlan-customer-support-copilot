# Source URL
https://developer.atlan.com/models/entities/dbtmodel/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/dbtmodel/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/dbtmodel.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DbtModel - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/dbtmodel/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/dbtmodel.png
meta-twitter:title: DbtModel - Developer
meta-viewport: width=device-width,initial-scale=1
title: DbtModel - Developer
-->

[Skip to content](#dbtmodel) Developer DbtModel Initializing search 
...
DbtModel[¶](#dbtmodel "Permanent link")
=======================================
...
This is a complete reference for the `DbtModel` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DbtModel` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DbtModel
    link DbtModel "../dbtmodel"
    class Dbt {
        <<abstract>>
    }
    link Dbt "../dbt"
...
These attributes are inherited from `DbtModel`'s supertypes (shown above):
...
These attributes are specific to instances of `DbtModel` (and all of its subtypes).

### dbtCompiledSQL [¶](#dbtcompiledsql "Permanent link")

TBC

### dbtError [¶](#dbterror "Permanent link")

TBC

### dbtMaterializationType [¶](#dbtmaterializationtype "Permanent link")

TBC

### dbtModelCompileCompletedAt [¶](#dbtmodelcompilecompletedat "Permanent link")

TBC

### dbtModelCompileStartedAt [¶](#dbtmodelcompilestartedat "Permanent link")

TBC

### dbtModelExecuteCompletedAt [¶](#dbtmodelexecutecompletedat "Permanent link")

TBC

### dbtModelExecuteStartedAt [¶](#dbtmodelexecutestartedat "Permanent link")

TBC

### dbtModelExecutionTime [¶](#dbtmodelexecutiontime "Permanent link")

TBC

### dbtModelRunElapsedTime [¶](#dbtmodelrunelapsedtime "Permanent link")

TBC

### dbtModelRunGeneratedAt [¶](#dbtmodelrungeneratedat "Permanent link")

TBC

### dbtRawSQL [¶](#dbtrawsql "Permanent link")

TBC

### dbtStats [¶](#dbtstats "Permanent link")

TBC

### dbtStatus [¶](#dbtstatus "Permanent link")
...
These relationships are inherited from `DbtModel`'s supertypes:
...
These relationships are specific to instances of `DbtModel` (and all of its subtypes).
...
### dbtModelSqlAssets  ([SQL](../sql/))[¶](#dbtmodelsqlassets-sql "Permanent link")
...
### sqlAsset  ([SQL](../sql/))[¶](#sqlasset-sql "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/dbtmodel/) to provide us with more information. 

Back to top

[Previous DbtMetric](../dbtmetric/) [Next DbtModelColumn](../dbtmodelcolumn/) 
