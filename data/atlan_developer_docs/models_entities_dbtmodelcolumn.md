# Source URL
https://developer.atlan.com/models/entities/dbtmodelcolumn/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/dbtmodelcolumn/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/dbtmodelcolumn.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DbtModelColumn - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/dbtmodelcolumn/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/dbtmodelcolumn.png
meta-twitter:title: DbtModelColumn - Developer
meta-viewport: width=device-width,initial-scale=1
title: DbtModelColumn - Developer
-->

[Skip to content](#dbtmodelcolumn) Developer DbtModelColumn Initializing search 
...
DbtModelColumn[¶](#dbtmodelcolumn "Permanent link")
===================================================
...
This is a complete reference for the `DbtModelColumn` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DbtModelColumn` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DbtModelColumn
    link DbtModelColumn "../dbtmodelcolumn"
    class Dbt {
        <<abstract>>
    }
    link Dbt "../dbt"
...
These attributes are inherited from `DbtModelColumn`'s supertypes (shown above):
...
These attributes are specific to instances of `DbtModelColumn` (and all of its subtypes).

### dbtModelColumnDataType [¶](#dbtmodelcolumndatatype "Permanent link")

TBC

### dbtModelColumnOrder [¶](#dbtmodelcolumnorder "Permanent link")

TBC

### dbtModelQualifiedName [¶](#dbtmodelqualifiedname "Permanent link")
...
These relationships are inherited from `DbtModelColumn`'s supertypes:
...
These relationships are specific to instances of `DbtModelColumn` (and all of its subtypes).

### dbtModel  ([DbtModel](../dbtmodel/))[¶](#dbtmodel-dbtmodel "Permanent link")

Model in which this dbt column exists.

### dbtModelColumnSqlColumns  ([Column](../column/))[¶](#dbtmodelcolumnsqlcolumns-column "Permanent link")
...
### sqlColumn  ([Column](../column/))[¶](#sqlcolumn-column "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/dbtmodelcolumn/) to provide us with more information. 

Back to top

[Previous DbtModel](../dbtmodel/) [Next DbtProcess](../dbtprocess/) 
