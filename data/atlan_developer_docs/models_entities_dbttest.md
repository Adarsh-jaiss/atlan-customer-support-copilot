# Source URL
https://developer.atlan.com/models/entities/dbttest/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/dbttest/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/dbttest.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DbtTest - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/dbttest/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/dbttest.png
meta-twitter:title: DbtTest - Developer
meta-viewport: width=device-width,initial-scale=1
title: DbtTest - Developer
-->

[Skip to content](#dbttest) Developer DbtTest Initializing search 
...
DbtTest[¶](#dbttest "Permanent link")
=====================================
...
This is a complete reference for the `DbtTest` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DbtTest` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DbtTest
    link DbtTest "../dbttest"
    class Dbt {
        <<abstract>>
    }
    link Dbt "../dbt"
...
These attributes are inherited from `DbtTest`'s supertypes (shown above):
...
These attributes are specific to instances of `DbtTest` (and all of its subtypes).

### dbtTestCompiledCode [¶](#dbttestcompiledcode "Permanent link")

Compiled code of the test (when the test is defined using Python).

### dbtTestCompiledSQL [¶](#dbttestcompiledsql "Permanent link")

Compiled SQL of the test.

### dbtTestError [¶](#dbttesterror "Permanent link")

Error message in the case of state being "error".

### dbtTestLanguage [¶](#dbttestlanguage "Permanent link")

Language in which the test is written, for example: SQL or Python.

### dbtTestRawCode [¶](#dbttestrawcode "Permanent link")

Raw code of the test (when the test is defined using Python).

### dbtTestRawSQL [¶](#dbttestrawsql "Permanent link")

Raw SQL of the test.

### dbtTestState [¶](#dbtteststate "Permanent link")

Test results. Can be one of, in order of severity, "error", "fail", "warn", "pass".

### dbtTestStatus [¶](#dbtteststatus "Permanent link")
...
These relationships are inherited from `DbtTest`'s supertypes:
...
These relationships are specific to instances of `DbtTest` (and all of its subtypes).
...
### sqlAssets  ([SQL](../sql/))[¶](#sqlassets-sql "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/dbttest/) to provide us with more information. 

Back to top

[Previous DbtTag](../dbttag/) [Next Domo](../../domo/) 
