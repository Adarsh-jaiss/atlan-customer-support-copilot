# Source URL
https://developer.atlan.com/models/entities/documentdbcollection/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/documentdbcollection/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/documentdbcollection.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DocumentDBCollection - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/documentdbcollection/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/documentdbcollection.png
meta-twitter:title: DocumentDBCollection - Developer
meta-viewport: width=device-width,initial-scale=1
title: DocumentDBCollection - Developer
-->

[Skip to content](#documentdbcollection) Developer DocumentDBCollection Initializing search 
...
This is a complete reference for the `DocumentDBCollection` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DocumentDBCollection` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DocumentDBCollection
    link DocumentDBCollection "../documentdbcollection"
    class Table
    link Table "../table"
...
These attributes are inherited from `DocumentDBCollection`'s supertypes (shown above):
...
These attributes are specific to instances of `DocumentDBCollection` (and all of its subtypes).

### documentDBCollectionAverageObjectSize [¶](#documentdbcollectionaverageobjectsize "Permanent link")

Average size of an object in the collection.

### documentDBCollectionExpireAfterSeconds [¶](#documentdbcollectionexpireafterseconds "Permanent link")

Seconds after which documents in a time series collection or clustered collection expire.

### documentDBCollectionIsCapped [¶](#documentdbcollectioniscapped "Permanent link")

Whether the collection is capped (true) or not (false).

### documentDBCollectionMaxSize [¶](#documentdbcollectionmaxsize "Permanent link")

Maximum size allowed in a capped collection.

### documentDBCollectionMaximumDocumentCount [¶](#documentdbcollectionmaximumdocumentcount "Permanent link")

Maximum number of documents allowed in a capped collection.

### documentDBCollectionNumIndexes [¶](#documentdbcollectionnumindexes "Permanent link")

Number of indexes on the collection.

### documentDBCollectionNumOrphanDocs [¶](#documentdbcollectionnumorphandocs "Permanent link")

Number of orphaned documents in the collection.

### documentDBCollectionSchemaDefinition [¶](#documentdbcollectionschemadefinition "Permanent link")

Definition of the schema applicable for the collection.

### documentDBCollectionSubtype [¶](#documentdbcollectionsubtype "Permanent link")

Subtype of a DocumentDB collection, for example: Capped, Time Series, etc.

### documentDBCollectionTimeField [¶](#documentdbcollectiontimefield "Permanent link")

Name of the field containing the date in each time series document.

### documentDBCollectionTimeGranularity [¶](#documentdbcollectiontimegranularity "Permanent link")

Closest match to the time span between consecutive incoming measurements.

### documentDBCollectionTotalIndexSize [¶](#documentdbcollectiontotalindexsize "Permanent link")
...
These relationships are inherited from `DocumentDBCollection`'s supertypes:
...
These relationships are specific to instances of `DocumentDBCollection` (and all of its subtypes).

### documentDBDatabase  ([DocumentDBDatabase](../documentdbdatabase/))[¶](#documentdbdatabase-documentdbdatabase "Permanent link")

Database in which the collection exists.

---

2023\-01\-042025\-04\-09

**Was this page helpful?**

Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/documentdbcollection/) to provide us with more information. 

Back to top

[Previous DocumentDB](../../documentdb/) [Next DocumentDBDatabase](../documentdbdatabase/) 
