# Source URL
https://developer.atlan.com/models/entities/domodashboard/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/domodashboard/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/domodashboard.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: DomoDashboard - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/domodashboard/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/domodashboard.png
meta-twitter:title: DomoDashboard - Developer
meta-viewport: width=device-width,initial-scale=1
title: DomoDashboard - Developer
-->

[Skip to content](#domodashboard) Developer DomoDashboard Initializing search 
...
DomoDashboard[¶](#domodashboard "Permanent link")
=================================================
...
This is a complete reference for the `DomoDashboard` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`DomoDashboard` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class DomoDashboard
    link DomoDashboard "../domodashboard"
    class Domo {
        <<abstract>>
    }
    link Domo "../domo"
...
These attributes are inherited from `DomoDashboard`'s supertypes (shown above):
...
These attributes are specific to instances of `DomoDashboard` (and all of its subtypes).

### domoDashboardCardCount [¶](#domodashboardcardcount "Permanent link")
...
These relationships are inherited from `DomoDashboard`'s supertypes:
...
These relationships are specific to instances of `DomoDashboard` (and all of its subtypes).

### domoCards  ([DomoCard](../domocard/))[¶](#domocards-domocard "Permanent link")

TBC

### domoDashboardChildren  ([DomoDashboard](./))[¶](#domodashboardchildren-domodashboard "Permanent link")

TBC

### domoDashboardParent  ([DomoDashboard](./))[¶](#domodashboardparent-domodashboard "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/domodashboard/) to provide us with more information. 

Back to top

[Previous DomoCard](../domocard/) [Next DomoDataset](../domodataset/) 
