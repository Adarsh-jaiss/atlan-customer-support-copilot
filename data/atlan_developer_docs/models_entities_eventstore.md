# Source URL
https://developer.atlan.com/models/entities/eventstore/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/eventstore/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/eventstore.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: EventStore - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/eventstore/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/eventstore.png
meta-twitter:title: EventStore - Developer
meta-viewport: width=device-width,initial-scale=1
title: EventStore - Developer
-->

[Skip to content](#eventstore) Developer EventStore Initializing search 
...
EventStore[¶](#eventstore "Permanent link")
===========================================
...
This is a complete reference for the `EventStore` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`EventStore` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `EventStore`'s supertypes (shown above):
...
These relationships are inherited from `EventStore`'s supertypes:
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/eventstore/) to provide us with more information. 

Back to top

[Previous ObjectStore](../objectstore/) [Next DataQuality](../dataquality/) 
