# Source URL
https://developer.atlan.com/models/entities/fivetranconnector/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/fivetranconnector/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/fivetranconnector.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: FivetranConnector - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/fivetranconnector/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/fivetranconnector.png
meta-twitter:title: FivetranConnector - Developer
meta-viewport: width=device-width,initial-scale=1
title: FivetranConnector - Developer
-->

[Skip to content](#fivetranconnector) Developer FivetranConnector Initializing search 
...
FivetranConnector[¶](#fivetranconnector "Permanent link")
=========================================================
...
This is a complete reference for the `FivetranConnector` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`FivetranConnector` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class FivetranConnector
    link FivetranConnector "../fivetranconnector"
    class Fivetran {
        <<abstract>>
    }
    link Fivetran "../fivetran"
...
These attributes are inherited from `FivetranConnector`'s supertypes (shown above):
...
These attributes are specific to instances of `FivetranConnector` (and all of its subtypes).

### fivetranConnectorCreditsUsed [¶](#fivetranconnectorcreditsused "Permanent link")

Total credits used by this destination

### fivetranConnectorDestinationName [¶](#fivetranconnectordestinationname "Permanent link")

Destination name added by the user on Fivetran

### fivetranConnectorDestinationType [¶](#fivetranconnectordestinationtype "Permanent link")

Type of destination on Fivetran. Eg: redshift, bigquery etc.

### fivetranConnectorDestinationURL [¶](#fivetranconnectordestinationurl "Permanent link")

URL to open the destination details on Fivetran

### fivetranConnectorLastSyncExtractTimeSeconds [¶](#fivetranconnectorlastsyncextracttimeseconds "Permanent link")

Extract time in seconds in the latest sync on fivetran

### fivetranConnectorLastSyncExtractVolumeMegabytes [¶](#fivetranconnectorlastsyncextractvolumemegabytes "Permanent link")

Extracted data volume in metabytes in the latest sync on Fivetran

### fivetranConnectorLastSyncFinishedAt [¶](#fivetranconnectorlastsyncfinishedat "Permanent link")

Timestamp (epoch) when the latest sync finished on Fivetran, in milliseconds

### fivetranConnectorLastSyncId [¶](#fivetranconnectorlastsyncid "Permanent link")

ID of the latest sync

### fivetranConnectorLastSyncLoadTimeSeconds [¶](#fivetranconnectorlastsyncloadtimeseconds "Permanent link")

Load time in seconds in the latest sync on Fivetran

### fivetranConnectorLastSyncLoadVolumeMegabytes [¶](#fivetranconnectorlastsyncloadvolumemegabytes "Permanent link")

Loaded data volume in metabytes in the latest sync on Fivetran

### fivetranConnectorLastSyncProcessTimeSeconds [¶](#fivetranconnectorlastsyncprocesstimeseconds "Permanent link")

Process time in seconds in the latest sync on Fivetran

### fivetranConnectorLastSyncProcessVolumeMegabytes [¶](#fivetranconnectorlastsyncprocessvolumemegabytes "Permanent link")

Process volume in metabytes in the latest sync on Fivetran

### fivetranConnectorLastSyncReason [¶](#fivetranconnectorlastsyncreason "Permanent link")

Failure reason for the latest sync on Fivetran. If status is FAILURE, this is the description of the reason why the sync failed. If status is FAILURE\_WITH\_TASK, this is the description of the Error. If status is RESCHEDULED, this is the description of the reason why the sync is rescheduled.

### fivetranConnectorLastSyncRescheduledAt [¶](#fivetranconnectorlastsyncrescheduledat "Permanent link")

Timestamp (epoch) at which the latest sync is rescheduled at on Fivetran

### fivetranConnectorLastSyncStartedAt [¶](#fivetranconnectorlastsyncstartedat "Permanent link")

Timestamp (epoch) when the latest sync started on Fivetran, in milliseconds

### fivetranConnectorLastSyncTablesSynced [¶](#fivetranconnectorlastsynctablessynced "Permanent link")

Number of tables synced in the latest sync on Fivetran

### fivetranConnectorLastSyncTaskType [¶](#fivetranconnectorlastsynctasktype "Permanent link")

Failure task type for the latest sync on Fivetran. If status is FAILURE\_WITH\_TASK or RESCHEDULED, this field displays the type of the Error that caused the failure or rescheduling, respectively, e.g., reconnect, update\_service\_account, etc.

### fivetranConnectorLastSyncTotalTimeSeconds [¶](#fivetranconnectorlastsynctotaltimeseconds "Permanent link")

Total sync time in seconds in the latest sync on Fivetran

### fivetranConnectorMonthlyActiveRowsChangePercentageFree [¶](#fivetranconnectormonthlyactiverowschangepercentagefree "Permanent link")

Increase in the percentage of free MAR compared to the previous month

### fivetranConnectorMonthlyActiveRowsChangePercentagePaid [¶](#fivetranconnectormonthlyactiverowschangepercentagepaid "Permanent link")

Increase in the percentage of paid MAR compared to the previous month

### fivetranConnectorMonthlyActiveRowsChangePercentageTotal [¶](#fivetranconnectormonthlyactiverowschangepercentagetotal "Permanent link")

Increase in the percentage of total MAR compared to the previous month

### fivetranConnectorMonthlyActiveRowsFree [¶](#fivetranconnectormonthlyactiverowsfree "Permanent link")

Free Monthly Active Rows used by the connector in the past month

### fivetranConnectorMonthlyActiveRowsFreePercentageOfAccount [¶](#fivetranconnectormonthlyactiverowsfreepercentageofaccount "Permanent link")

Percentage of the account's total free MAR used by this connector

### fivetranConnectorMonthlyActiveRowsPaid [¶](#fivetranconnectormonthlyactiverowspaid "Permanent link")

Paid Monthly Active Rows used by the connector in the past month

### fivetranConnectorMonthlyActiveRowsPaidPercentageOfAccount [¶](#fivetranconnectormonthlyactiverowspaidpercentageofaccount "Permanent link")

Percentage of the account's total paid MAR used by this connector

### fivetranConnectorMonthlyActiveRowsTotal [¶](#fivetranconnectormonthlyactiverowstotal "Permanent link")

Total Monthly Active Rows used by the connector in the past month

### fivetranConnectorMonthlyActiveRowsTotalPercentageOfAccount [¶](#fivetranconnectormonthlyactiverowstotalpercentageofaccount "Permanent link")

Percentage of the account's total MAR used by this connector

### fivetranConnectorName [¶](#fivetranconnectorname "Permanent link")

Connector name added by the user on Fivetran

### fivetranConnectorSyncFrequency [¶](#fivetranconnectorsyncfrequency "Permanent link")

Sync frequency for the connector in number of hours. Eg: Every 6 hours

### fivetranConnectorSyncPaused [¶](#fivetranconnectorsyncpaused "Permanent link")

Boolean to indicate whether the sync for this connector is paused or not

### fivetranConnectorSyncSetupOn [¶](#fivetranconnectorsyncsetupon "Permanent link")

Timestamp (epoch) on which the connector was setup on Fivetran, in milliseconds

### fivetranConnectorSyncSetupUserEmail [¶](#fivetranconnectorsyncsetupuseremail "Permanent link")

Email ID of the user who setpu the connector on Fivetran

### fivetranConnectorSyncSetupUserFullName [¶](#fivetranconnectorsyncsetupuserfullname "Permanent link")

Full name of the user who setup the connector on Fivetran

### fivetranConnectorTopTablesByMAR [¶](#fivetranconnectortoptablesbymar "Permanent link")

Total five tables sorted by MAR synced by this connector

### fivetranConnectorTotalTablesSynced [¶](#fivetranconnectortotaltablessynced "Permanent link")

Total number of tables synced by this connector

### fivetranConnectorType [¶](#fivetranconnectortype "Permanent link")

Type of connector on Fivetran. Eg: snowflake, google\_analytics, notion etc.

### fivetranConnectorURL [¶](#fivetranconnectorurl "Permanent link")

URL to open the connector details on Fivetran

### fivetranConnectorUsageCost [¶](#fivetranconnectorusagecost "Permanent link")
...
These relationships are inherited from `FivetranConnector`'s supertypes:
...
These relationships are specific to instances of `FivetranConnector` (and all of its subtypes).

### processes  ([Process](../../lineage/))[¶](#processes-process "Permanent link")

Processes related to this Fivetran connector

---

2023\-05\-042024\-11\-29

**Was this page helpful?**

Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/fivetranconnector/) to provide us with more information. 

Back to top

[Previous Fivetran](../../fivetran/) [Next Google](../../google/) 
