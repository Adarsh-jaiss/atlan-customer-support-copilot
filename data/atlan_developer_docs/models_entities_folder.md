# Source URL
https://developer.atlan.com/models/entities/folder/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/folder/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/folder.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Folder - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/folder/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/folder.png
meta-twitter:title: Folder - Developer
meta-viewport: width=device-width,initial-scale=1
title: Folder - Developer
-->

[Skip to content](#folder) Developer Folder Initializing search 
...
This is a complete reference for the `Folder` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`Folder` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `Folder`'s supertypes (shown above):
...
These attributes are specific to instances of `Folder` (and all of its subtypes).
...
These relationships are inherited from `Folder`'s supertypes:
...
### childrenFolders  ([Folder](./))[¶](#childrenfolders-folder "Permanent link")

Folders that exist within this namespace.

### childrenQueries  ([Query](../query/))[¶](#childrenqueries-query "Permanent link")

Queries that exist within this namespace.

These relationships are specific to instances of `Folder` (and all of its subtypes).
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/folder/) to provide us with more information. 

Back to top

[Previous Collection](../collection/) [Next Cubes](../../multidimensionaldataset/) 
