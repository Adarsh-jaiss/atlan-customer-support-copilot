# Source URL
https://developer.atlan.com/models/entities/gcsobject/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/gcsobject/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/gcsobject.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: GCSObject - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/gcsobject/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/gcsobject.png
meta-twitter:title: GCSObject - Developer
meta-viewport: width=device-width,initial-scale=1
title: GCSObject - Developer
-->

[Skip to content](#gcsobject) Developer GCSObject Initializing search 
...
This is a complete reference for the `GCSObject` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`GCSObject` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class GCSObject
    link GCSObject "../gcsobject"
    class GCS {
        <<abstract>>
    }
    link GCS "../gcs"
...
These attributes are inherited from `GCSObject`'s supertypes (shown above):
...
These attributes are specific to instances of `GCSObject` (and all of its subtypes).

### gcsBucketName [¶](#gcsbucketname "Permanent link")

Simple name of the bucket in which this object exists.

### gcsBucketQualifiedName [¶](#gcsbucketqualifiedname "Permanent link")

Unique name of the bucket in which this object exists.

### gcsObjectCRC32CHash [¶](#gcsobjectcrc32chash "Permanent link")

CRC32C hash of this object.

### gcsObjectContentDisposition [¶](#gcsobjectcontentdisposition "Permanent link")

Information about how this object's content should be presented.

### gcsObjectContentEncoding [¶](#gcsobjectcontentencoding "Permanent link")

Content encoding of this object.

### gcsObjectContentLanguage [¶](#gcsobjectcontentlanguage "Permanent link")

Language of this object's contents.

### gcsObjectContentType [¶](#gcsobjectcontenttype "Permanent link")

Type of content in this object.

### gcsObjectDataLastModifiedTime [¶](#gcsobjectdatalastmodifiedtime "Permanent link")

Time (epoch) at which this object's data was last modified, in milliseconds.

### gcsObjectGenerationId [¶](#gcsobjectgenerationid "Permanent link")

Generation ID of this object.

### gcsObjectHoldType [¶](#gcsobjectholdtype "Permanent link")

Type of hold on this object.

### gcsObjectKey [¶](#gcsobjectkey "Permanent link")

Key of this object, in GCS.

### gcsObjectMD5Hash [¶](#gcsobjectmd5hash "Permanent link")

MD5 hash of this object.

### gcsObjectMediaLink [¶](#gcsobjectmedialink "Permanent link")

Media link to this object.

### gcsObjectRetentionExpirationDate [¶](#gcsobjectretentionexpirationdate "Permanent link")

Retention expiration date of this object.

### gcsObjectSize [¶](#gcsobjectsize "Permanent link")
...
These relationships are inherited from `GCSObject`'s supertypes:
...
These relationships are specific to instances of `GCSObject` (and all of its subtypes).

### gcsBucket  ([GCSBucket](../gcsbucket/))[¶](#gcsbucket-gcsbucket "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/gcsobject/) to provide us with more information. 

Back to top

[Previous GCSBucket](../gcsbucket/) [Next Google Data Studio](../../gds/) 
