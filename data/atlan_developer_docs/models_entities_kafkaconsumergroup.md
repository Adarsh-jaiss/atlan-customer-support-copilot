# Source URL
https://developer.atlan.com/models/entities/kafkaconsumergroup/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/kafkaconsumergroup/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/kafkaconsumergroup.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: KafkaConsumerGroup - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/kafkaconsumergroup/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/kafkaconsumergroup.png
meta-twitter:title: KafkaConsumerGroup - Developer
meta-viewport: width=device-width,initial-scale=1
title: KafkaConsumerGroup - Developer
-->

[Skip to content](#kafkaconsumergroup) Developer KafkaConsumerGroup Initializing search 
...
This is a complete reference for the `KafkaConsumerGroup` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`KafkaConsumerGroup` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class KafkaConsumerGroup
    link KafkaConsumerGroup "../kafkaconsumergroup"
    class Kafka {
        <<abstract>>
    }
    link Kafka "../kafka"
...
These attributes are inherited from `KafkaConsumerGroup`'s supertypes (shown above):
...
These attributes are specific to instances of `KafkaConsumerGroup` (and all of its subtypes).

### kafkaConsumerGroupMemberCount [¶](#kafkaconsumergroupmembercount "Permanent link")

Number of members in this consumer group.

### kafkaConsumerGroupTopicConsumptionProperties [¶](#kafkaconsumergrouptopicconsumptionproperties "Permanent link")

List of consumption properties for Kafka topics, for this consumer group.

### kafkaTopicNames [¶](#kafkatopicnames "Permanent link")

Simple names of the topics consumed by this consumer group.

### kafkaTopicQualifiedNames [¶](#kafkatopicqualifiednames "Permanent link")
...
These relationships are inherited from `KafkaConsumerGroup`'s supertypes:
...
These relationships are specific to instances of `KafkaConsumerGroup` (and all of its subtypes).

### kafkaTopics  ([KafkaTopic](../kafkatopic/))[¶](#kafkatopics-kafkatopic "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/kafkaconsumergroup/) to provide us with more information. 

Back to top

[Previous Kafka](../../kafka/) [Next KafkaTopic](../kafkatopic/) 
