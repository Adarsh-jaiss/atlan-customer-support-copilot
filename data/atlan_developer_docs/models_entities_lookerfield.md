# Source URL
https://developer.atlan.com/models/entities/lookerfield/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/lookerfield/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/lookerfield.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: LookerField - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/lookerfield/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/lookerfield.png
meta-twitter:title: LookerField - Developer
meta-viewport: width=device-width,initial-scale=1
title: LookerField - Developer
-->

[Skip to content](#lookerfield) Developer LookerField Initializing search 
...
LookerField[¶](#lookerfield "Permanent link")
=============================================
...
This is a complete reference for the `LookerField` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`LookerField` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class LookerField
    link LookerField "../lookerfield"
    class Looker {
        <<abstract>>
    }
    link Looker "../looker"
...
These attributes are inherited from `LookerField`'s supertypes (shown above):
...
These attributes are specific to instances of `LookerField` (and all of its subtypes).

### lookerDashboardQualifiedName [¶](#lookerdashboardqualifiedname "Permanent link")

Unique name of the dashboard in which this field is used.

### lookerExploreQualifiedName [¶](#lookerexplorequalifiedname "Permanent link")

Unique name of the Explore in which this field exists.

### lookerFieldDataType [¶](#lookerfielddatatype "Permanent link")

Deprecated.

### lookerFieldIsRefined [¶](#lookerfieldisrefined "Permanent link")

Whether the looker field asset is coming from a refinement

### lookerFieldRefinementFilePath [¶](#lookerfieldrefinementfilepath "Permanent link")

Absolute path of the file where the refinement of the field is declared.

### lookerFieldRefinementLineNumber [¶](#lookerfieldrefinementlinenumber "Permanent link")

Line number in the lookerFieldRefinementFilePath where this refinement of the field is declared.

### lookerLookQualifiedName [¶](#lookerlookqualifiedname "Permanent link")

Unique name of the look in which this field is used.

### lookerTileQualifiedName [¶](#lookertilequalifiedname "Permanent link")

Unique name of the tile in which this field is used.

### lookerTimesUsed [¶](#lookertimesused "Permanent link")

Deprecated.

### lookerViewQualifiedName [¶](#lookerviewqualifiedname "Permanent link")
...
### projectName [¶](#projectname "Permanent link")

Name of the project in which this field exists.

### sourceDefinition [¶](#sourcedefinition "Permanent link")
...
These relationships are inherited from `LookerField`'s supertypes:
...
These relationships are specific to instances of `LookerField` (and all of its subtypes).

### dashboard  ([LookerDashboard](../lookerdashboard/))[¶](#dashboard-lookerdashboard "Permanent link")

Dashboard in which this field is used.

### explore  ([LookerExplore](../lookerexplore/))[¶](#explore-lookerexplore "Permanent link")

Explore in which this field exists.

### look  ([LookerLook](../lookerlook/))[¶](#look-lookerlook "Permanent link")

Look in which this field is used.

### model  ([LookerModel](../lookermodel/))[¶](#model-lookermodel "Permanent link")

Model in which this field exists.

### project  ([LookerProject](../lookerproject/))[¶](#project-lookerproject "Permanent link")

Project in which this field exists.

### tile  ([LookerTile](../lookertile/))[¶](#tile-lookertile "Permanent link")

Tile in which this field is used.

### view  ([LookerView](../lookerview/))[¶](#view-lookerview "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/lookerfield/) to provide us with more information. 

Back to top

[Previous LookerExplore](../lookerexplore/) [Next LookerFolder](../lookerfolder/) 
