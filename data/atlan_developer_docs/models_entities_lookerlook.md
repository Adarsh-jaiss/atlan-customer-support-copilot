# Source URL
https://developer.atlan.com/models/entities/lookerlook/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/lookerlook/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/lookerlook.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: LookerLook - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/lookerlook/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/lookerlook.png
meta-twitter:title: LookerLook - Developer
meta-viewport: width=device-width,initial-scale=1
title: LookerLook - Developer
-->

[Skip to content](#lookerlook) Developer LookerLook Initializing search 
...
LookerLook[¶](#lookerlook "Permanent link")
===========================================
...
This is a complete reference for the `LookerLook` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`LookerLook` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class LookerLook
    link LookerLook "../lookerlook"
    class Looker {
        <<abstract>>
    }
    link Looker "../looker"
...
These attributes are inherited from `LookerLook`'s supertypes (shown above):
...
These attributes are specific to instances of `LookerLook` (and all of its subtypes).

### folderName [¶](#foldername "Permanent link")
...
### sourceContentMetadataId [¶](#sourcecontentmetadataid "Permanent link")

Identifier of the Look's content metadata, from Looker.

### sourceLastAccessedAt [¶](#sourcelastaccessedat "Permanent link")

Time (epoch) when the Look was last accessed by a user, in milliseconds.

### sourceLastViewedAt [¶](#sourcelastviewedat "Permanent link")

Time (epoch) when the Look was last viewed by a user, in milliseconds.

### sourceQueryId [¶](#sourcequeryid "Permanent link")

Identifier of the query for the Look, from Looker.

### sourceUserId [¶](#sourceuserid "Permanent link")

Identifier of the user who created the Look, from Looker.

### sourceViewCount [¶](#sourceviewcount "Permanent link")

Number of times the look has been viewed in the Looker web UI.

### sourcelastUpdaterId [¶](#sourcelastupdaterid "Permanent link")
...
These relationships are inherited from `LookerLook`'s supertypes:
...
These relationships are specific to instances of `LookerLook` (and all of its subtypes).

### dashboard  ([LookerDashboard](../lookerdashboard/))[¶](#dashboard-lookerdashboard "Permanent link")

Dashboard in which this Look is used.

### fields  ([LookerField](../lookerfield/))[¶](#fields-lookerfield "Permanent link")

Fields that are used in this look.

### folder  ([LookerFolder](../lookerfolder/))[¶](#folder-lookerfolder "Permanent link")
...
### query  ([LookerQuery](../lookerquery/))[¶](#query-lookerquery "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/lookerlook/) to provide us with more information. 

Back to top

[Previous LookerFolder](../lookerfolder/) [Next LookerModel](../lookermodel/) 
