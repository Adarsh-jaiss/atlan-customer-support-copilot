# Source URL
https://developer.atlan.com/models/entities/lookerproject/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/lookerproject/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/lookerproject.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: LookerProject - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/lookerproject/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/lookerproject.png
meta-twitter:title: LookerProject - Developer
meta-viewport: width=device-width,initial-scale=1
title: LookerProject - Developer
-->

[Skip to content](#lookerproject) Developer LookerProject Initializing search 
...
LookerProject[¶](#lookerproject "Permanent link")
=================================================
...
This is a complete reference for the `LookerProject` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`LookerProject` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class LookerProject
    link LookerProject "../lookerproject"
    class Looker {
        <<abstract>>
    }
    link Looker "../looker"
...
These attributes are inherited from `LookerProject`'s supertypes (shown above):
...
These relationships are inherited from `LookerProject`'s supertypes:
...
These relationships are specific to instances of `LookerProject` (and all of its subtypes).

### explores  ([LookerExplore](../lookerexplore/))[¶](#explores-lookerexplore "Permanent link")
...
### lookerChildProjects  ([LookerProject](./))[¶](#lookerchildprojects-lookerproject "Permanent link")

TBC

### lookerParentProjects  ([LookerProject](./))[¶](#lookerparentprojects-lookerproject "Permanent link")

TBC

### models  ([LookerModel](../lookermodel/))[¶](#models-lookermodel "Permanent link")

Models that exist within this project.

### views  ([LookerView](../lookerview/))[¶](#views-lookerview "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/lookerproject/) to provide us with more information. 

Back to top

[Previous LookerModel](../lookermodel/) [Next LookerQuery](../lookerquery/) 
