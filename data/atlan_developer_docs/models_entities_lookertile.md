# Source URL
https://developer.atlan.com/models/entities/lookertile/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/lookertile/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/lookertile.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: LookerTile - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/lookertile/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/lookertile.png
meta-twitter:title: LookerTile - Developer
meta-viewport: width=device-width,initial-scale=1
title: LookerTile - Developer
-->

[Skip to content](#lookertile) Developer LookerTile Initializing search 
...
LookerTile[¶](#lookertile "Permanent link")
===========================================
...
This is a complete reference for the `LookerTile` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`LookerTile` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class LookerTile
    link LookerTile "../lookertile"
    class Looker {
        <<abstract>>
    }
    link Looker "../looker"
...
These attributes are inherited from `LookerTile`'s supertypes (shown above):
...
These attributes are specific to instances of `LookerTile` (and all of its subtypes).

### lookId [¶](#lookid "Permanent link")

Identifier of the Look used to create this tile, from Looker.

### lookmlLinkId [¶](#lookmllinkid "Permanent link")

Identifier for the LoomML link.

### mergeResultId [¶](#mergeresultid "Permanent link")

Identifier for the merge result.

### noteText [¶](#notetext "Permanent link")

Text of notes added to the tile.

### queryID [¶](#queryid "Permanent link")

Identifier for the query used to build this tile, from Looker.

### resultMakerID [¶](#resultmakerid "Permanent link")

Identifier of the ResultMarkerLookup entry, from Looker.

### subtitleText [¶](#subtitletext "Permanent link")
...
These relationships are inherited from `LookerTile`'s supertypes:
...
These relationships are specific to instances of `LookerTile` (and all of its subtypes).
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/lookertile/) to provide us with more information. 

Back to top

[Previous LookerQuery](../lookerquery/) [Next LookerView](../lookerview/) 
