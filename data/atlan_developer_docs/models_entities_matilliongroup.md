# Source URL
https://developer.atlan.com/models/entities/matilliongroup/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/matilliongroup/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/matilliongroup.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MatillionGroup - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/matilliongroup/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/matilliongroup.png
meta-twitter:title: MatillionGroup - Developer
meta-viewport: width=device-width,initial-scale=1
title: MatillionGroup - Developer
-->

[Skip to content](#matilliongroup) Developer MatillionGroup Initializing search 
...
MatillionGroup[¶](#matilliongroup "Permanent link")
===================================================
...
This is a complete reference for the `MatillionGroup` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`MatillionGroup` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class MatillionGroup
    link MatillionGroup "../matilliongroup"
    class Matillion {
        <<abstract>>
    }
...
These attributes are inherited from `MatillionGroup`'s supertypes (shown above):
...
These attributes are specific to instances of `MatillionGroup` (and all of its subtypes).

### matillionProjectCount [¶](#matillionprojectcount "Permanent link")
...
These relationships are inherited from `MatillionGroup`'s supertypes:
...
These relationships are specific to instances of `MatillionGroup` (and all of its subtypes).

### matillionProjects  ([MatillionProject](../matillionproject/))[¶](#matillionprojects-matillionproject "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/matilliongroup/) to provide us with more information. 

Back to top

[Previous MatillionComponent](../matillioncomponent/) [Next MatillionJob](../matillionjob/) 
