# Source URL
https://developer.atlan.com/models/entities/matillionjob/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/matillionjob/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/matillionjob.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MatillionJob - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/matillionjob/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/matillionjob.png
meta-twitter:title: MatillionJob - Developer
meta-viewport: width=device-width,initial-scale=1
title: MatillionJob - Developer
-->

[Skip to content](#matillionjob) Developer MatillionJob Initializing search 
...
MatillionJob[¶](#matillionjob "Permanent link")
===============================================
...
This is a complete reference for the `MatillionJob` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`MatillionJob` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class MatillionJob
    link MatillionJob "../matillionjob"
    class Matillion {
        <<abstract>>
    }
...
These attributes are inherited from `MatillionJob`'s supertypes (shown above):
...
These attributes are specific to instances of `MatillionJob` (and all of its subtypes).

### matillionJobComponentCount [¶](#matillionjobcomponentcount "Permanent link")

Number of components within the job.

### matillionJobPath [¶](#matillionjobpath "Permanent link")

Path of the job within the project. Jobs can be managed at multiple folder levels within a project.

### matillionJobSchedule [¶](#matillionjobschedule "Permanent link")

How the job is scheduled, for example: weekly or monthly.

### matillionJobType [¶](#matillionjobtype "Permanent link")

Type of the job, for example: orchestration or transformation.

### matillionProjectName [¶](#matillionprojectname "Permanent link")

Simple name of the project to which the job belongs.

### matillionProjectQualifiedName [¶](#matillionprojectqualifiedname "Permanent link")
...
These relationships are inherited from `MatillionJob`'s supertypes:
...
These relationships are specific to instances of `MatillionJob` (and all of its subtypes).

### matillionComponents  ([MatillionComponent](../matillioncomponent/))[¶](#matillioncomponents-matillioncomponent "Permanent link")

Components that exist within this job.

### matillionProject  ([MatillionProject](../matillionproject/))[¶](#matillionproject-matillionproject "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/matillionjob/) to provide us with more information. 

Back to top

[Previous MatillionGroup](../matilliongroup/) [Next MatillionProject](../matillionproject/) 
