# Source URL
https://developer.atlan.com/models/entities/matillionproject/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/matillionproject/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/matillionproject.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MatillionProject - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/matillionproject/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/matillionproject.png
meta-twitter:title: MatillionProject - Developer
meta-viewport: width=device-width,initial-scale=1
title: MatillionProject - Developer
-->

[Skip to content](#matillionproject) Developer MatillionProject Initializing search 
...
MatillionProject[¶](#matillionproject "Permanent link")
=======================================================
...
This is a complete reference for the `MatillionProject` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`MatillionProject` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class MatillionProject
    link MatillionProject "../matillionproject"
    class Matillion {
        <<abstract>>
    }
...
These attributes are inherited from `MatillionProject`'s supertypes (shown above):
...
These attributes are specific to instances of `MatillionProject` (and all of its subtypes).

### matillionEnvironments [¶](#matillionenvironments "Permanent link")

List of environments in the project.

### matillionGroupName [¶](#matilliongroupname "Permanent link")

Simple name of the Matillion group to which the project belongs.

### matillionGroupQualifiedName [¶](#matilliongroupqualifiedname "Permanent link")

Unique name of the Matillion group to which the project belongs.

### matillionProjectJobCount [¶](#matillionprojectjobcount "Permanent link")

Number of jobs in the project.

### matillionVersions [¶](#matillionversions "Permanent link")
...
These relationships are inherited from `MatillionProject`'s supertypes:
...
These relationships are specific to instances of `MatillionProject` (and all of its subtypes).

### matillionGroup  ([MatillionGroup](../matilliongroup/))[¶](#matilliongroup-matilliongroup "Permanent link")

Matillion group in which the project exists.

### matillionJobs  ([MatillionJob](../matillionjob/))[¶](#matillionjobs-matillionjob "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/matillionproject/) to provide us with more information. 

Back to top

[Previous MatillionJob](../matillionjob/) [Next Metabase](../../metabase/) 
