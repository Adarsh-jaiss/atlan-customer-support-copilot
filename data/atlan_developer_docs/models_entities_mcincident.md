# Source URL
https://developer.atlan.com/models/entities/mcincident/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/mcincident/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/mcincident.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MCIncident - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/mcincident/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/mcincident.png
meta-twitter:title: MCIncident - Developer
meta-viewport: width=device-width,initial-scale=1
title: MCIncident - Developer
-->

[Skip to content](#mcincident) Developer MCIncident Initializing search 
...
MCIncident[¶](#mcincident "Permanent link")
===========================================
...
`MCIncident` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `MCIncident`'s supertypes (shown above):
...
These attributes are specific to instances of `MCIncident` (and all of its subtypes).

### mcIncidentId [¶](#mcincidentid "Permanent link")

Identifier of this incident, from Monte Carlo.

### mcIncidentPriority [¶](#mcincidentpriority "Permanent link")

Priority of this incident inherited from monitor.

### mcIncidentSeverity [¶](#mcincidentseverity "Permanent link")

Severity of this incident.

### mcIncidentState [¶](#mcincidentstate "Permanent link")

State of this incident.

### mcIncidentSubTypes [¶](#mcincidentsubtypes "Permanent link")

Subtypes of this incident.

### mcIncidentType [¶](#mcincidenttype "Permanent link")

Type of this incident.

### mcIncidentWarehouse [¶](#mcincidentwarehouse "Permanent link")
...
These relationships are inherited from `MCIncident`'s supertypes:
...
### mcIncidents  ([MCIncident](./))[¶](#mcincidents-mcincident "Permanent link")
...
These relationships are specific to instances of `MCIncident` (and all of its subtypes).

### mcIncidentAssets  ([Asset](../asset/))[¶](#mcincidentassets-asset "Permanent link")

TBC

### mcMonitor  ([MCMonitor](../mcmonitor/))[¶](#mcmonitor-mcmonitor "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/mcincident/) to provide us with more information. 

Back to top

[Previous MonteCarlo](../../montecarlo/) [Next MCMonitor](../mcmonitor/) 
