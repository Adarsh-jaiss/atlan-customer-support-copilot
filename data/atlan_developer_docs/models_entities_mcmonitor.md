# Source URL
https://developer.atlan.com/models/entities/mcmonitor/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/mcmonitor/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/mcmonitor.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MCMonitor - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/mcmonitor/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/mcmonitor.png
meta-twitter:title: MCMonitor - Developer
meta-viewport: width=device-width,initial-scale=1
title: MCMonitor - Developer
-->

[Skip to content](#mcmonitor) Developer MCMonitor Initializing search 
...
MCMonitor[¶](#mcmonitor "Permanent link")
=========================================
...
This is a complete reference for the `MCMonitor` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`MCMonitor` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class MCMonitor
    link MCMonitor "../mcmonitor"
    class MonteCarlo {
        <<abstract>>
    }
...
These attributes are inherited from `MCMonitor`'s supertypes (shown above):
...
### mcAssetQualifiedNames [¶](#mcassetqualifiednames "Permanent link")

List of unique names of assets that are part of this Monte Carlo asset.

### mcLabels [¶](#mclabels "Permanent link")

List of labels for this Monte Carlo asset.

These attributes are specific to instances of `MCMonitor` (and all of its subtypes).

### mcMonitorAlertCondition [¶](#mcmonitoralertcondition "Permanent link")

Condition on which the monitor produces an alert.

### mcMonitorAlertCount [¶](#mcmonitoralertcount "Permanent link")

Number of alerts associated with this monitor.

### mcMonitorBreachRate [¶](#mcmonitorbreachrate "Permanent link")

Rate at which this monitor is breached.

### mcMonitorId [¶](#mcmonitorid "Permanent link")

Unique identifier for this monitor, from Monte Carlo.

### mcMonitorIncidentCount [¶](#mcmonitorincidentcount "Permanent link")

Number of incidents associated with this monitor.

### mcMonitorIsOotb [¶](#mcmonitorisootb "Permanent link")

Whether the monitor is OOTB or not

### mcMonitorNamespace [¶](#mcmonitornamespace "Permanent link")

Namespace of this monitor.

### mcMonitorPriority [¶](#mcmonitorpriority "Permanent link")

Priority of this monitor.

### mcMonitorRuleComparisons [¶](#mcmonitorrulecomparisons "Permanent link")

Comparison logic used for the rule.

### mcMonitorRuleCustomSql [¶](#mcmonitorrulecustomsql "Permanent link")

SQL code for custom SQL rules.

### mcMonitorRuleIsSnoozed [¶](#mcmonitorruleissnoozed "Permanent link")

Whether the rule is currently snoozed (true) or not (false).

### mcMonitorRuleNextExecutionTime [¶](#mcmonitorrulenextexecutiontime "Permanent link")

Time at which the next execution of the rule should occur.

### mcMonitorRulePreviousExecutionTime [¶](#mcmonitorrulepreviousexecutiontime "Permanent link")

Time at which the previous execution of the rule occurred.

### mcMonitorRuleScheduleConfig [¶](#mcmonitorrulescheduleconfig "Permanent link")

Schedule details for the rule.

### mcMonitorRuleScheduleConfigHumanized [¶](#mcmonitorrulescheduleconfighumanized "Permanent link")

Readable description of the schedule for the rule.

### mcMonitorRuleType [¶](#mcmonitorruletype "Permanent link")

Type of rule for this monitor.

### mcMonitorScheduleType [¶](#mcmonitorscheduletype "Permanent link")

Type of schedule for this monitor, for example: fixed or dynamic.

### mcMonitorStatus [¶](#mcmonitorstatus "Permanent link")

Status of this monitor.

### mcMonitorType [¶](#mcmonitortype "Permanent link")

Type of this monitor, for example: field health (stats) or dimension tracking (categories).

### mcMonitorWarehouse [¶](#mcmonitorwarehouse "Permanent link")
...
These relationships are inherited from `MCMonitor`'s supertypes:
...
### mcMonitors  ([MCMonitor](./))[¶](#mcmonitors-mcmonitor "Permanent link")
...
These relationships are specific to instances of `MCMonitor` (and all of its subtypes).

### mcMonitorAssets  ([Asset](../asset/))[¶](#mcmonitorassets-asset "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/mcmonitor/) to provide us with more information. 

Back to top

[Previous MCIncident](../mcincident/) [Next PowerBI](../../powerbi/) 
