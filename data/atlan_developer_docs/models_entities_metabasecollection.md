# Source URL
https://developer.atlan.com/models/entities/metabasecollection/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/metabasecollection/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/metabasecollection.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MetabaseCollection - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/metabasecollection/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/metabasecollection.png
meta-twitter:title: MetabaseCollection - Developer
meta-viewport: width=device-width,initial-scale=1
title: MetabaseCollection - Developer
-->

[Skip to content](#metabasecollection) Developer MetabaseCollection Initializing search 
...
MetabaseCollection[¶](#metabasecollection "Permanent link")
===========================================================
...
This is a complete reference for the `MetabaseCollection` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`MetabaseCollection` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class MetabaseCollection
    link MetabaseCollection "../metabasecollection"
    class Metabase {
        <<abstract>>
    }
...
These attributes are inherited from `MetabaseCollection`'s supertypes (shown above):
...
These attributes are specific to instances of `MetabaseCollection` (and all of its subtypes).

### metabaseColor [¶](#metabasecolor "Permanent link")

TBC

### metabaseIsPersonalCollection [¶](#metabaseispersonalcollection "Permanent link")

TBC

### metabaseNamespace [¶](#metabasenamespace "Permanent link")

TBC

### metabaseSlug [¶](#metabaseslug "Permanent link")
...
These relationships are inherited from `MetabaseCollection`'s supertypes:
...
These relationships are specific to instances of `MetabaseCollection` (and all of its subtypes).

### metabaseDashboards  ([MetabaseDashboard](../metabasedashboard/))[¶](#metabasedashboards-metabasedashboard "Permanent link")

Dashboards that exist within this collection.

### metabaseQuestions  ([MetabaseQuestion](../metabasequestion/))[¶](#metabasequestions-metabasequestion "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/metabasecollection/) to provide us with more information. 

Back to top

[Previous Metabase](../../metabase/) [Next MetabaseDashboard](../metabasedashboard/) 
