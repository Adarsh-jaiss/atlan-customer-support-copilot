# Source URL
https://developer.atlan.com/models/entities/metabasequestion/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/metabasequestion/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/metabasequestion.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MetabaseQuestion - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/metabasequestion/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/metabasequestion.png
meta-twitter:title: MetabaseQuestion - Developer
meta-viewport: width=device-width,initial-scale=1
title: MetabaseQuestion - Developer
-->

[Skip to content](#metabasequestion) Developer MetabaseQuestion Initializing search 
...
MetabaseQuestion[¶](#metabasequestion "Permanent link")
=======================================================
...
This is a complete reference for the `MetabaseQuestion` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`MetabaseQuestion` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class MetabaseQuestion
    link MetabaseQuestion "../metabasequestion"
    class Metabase {
        <<abstract>>
    }
...
These attributes are inherited from `MetabaseQuestion`'s supertypes (shown above):
...
These attributes are specific to instances of `MetabaseQuestion` (and all of its subtypes).

### metabaseDashboardCount [¶](#metabasedashboardcount "Permanent link")

TBC

### metabaseQuery [¶](#metabasequery "Permanent link")

TBC

### metabaseQueryType [¶](#metabasequerytype "Permanent link")
...
These relationships are inherited from `MetabaseQuestion`'s supertypes:
...
These relationships are specific to instances of `MetabaseQuestion` (and all of its subtypes).

### metabaseCollection  ([MetabaseCollection](../metabasecollection/))[¶](#metabasecollection-metabasecollection "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/metabasequestion/) to provide us with more information. 

Back to top

[Previous MetabaseDashboard](../metabasedashboard/) [Next MicroStrategy](../../microstrategy/) 
