# Source URL
https://developer.atlan.com/models/entities/microstrategymetric/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/microstrategymetric/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/microstrategymetric.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: MicroStrategyMetric - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/microstrategymetric/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/microstrategymetric.png
meta-twitter:title: MicroStrategyMetric - Developer
meta-viewport: width=device-width,initial-scale=1
title: MicroStrategyMetric - Developer
-->

[Skip to content](#microstrategymetric) Developer MicroStrategyMetric Initializing search 
...
MicroStrategyMetric[¶](#microstrategymetric "Permanent link")
=============================================================
...
This is a complete reference for the `MicroStrategyMetric` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`MicroStrategyMetric` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class MicroStrategyMetric
    link MicroStrategyMetric "../microstrategymetric"
    class MicroStrategy {
        <<abstract>>
    }
...
These attributes are inherited from `MicroStrategyMetric`'s supertypes (shown above):
...
These attributes are specific to instances of `MicroStrategyMetric` (and all of its subtypes).

### microStrategyAttributeNames [¶](#microstrategyattributenames "Permanent link")

List of simple names of attributes related to this metric.

### microStrategyAttributeQualifiedNames [¶](#microstrategyattributequalifiednames "Permanent link")

List of unique names of attributes related to this metric.

### microStrategyFactNames [¶](#microstrategyfactnames "Permanent link")

List of simple names of facts related to this metric.

### microStrategyFactQualifiedNames [¶](#microstrategyfactqualifiednames "Permanent link")

List of unique names of facts related to this metric.

### microStrategyMetricExpression [¶](#microstrategymetricexpression "Permanent link")

Text specifiying this metric's expression.

### microStrategyMetricParentNames [¶](#microstrategymetricparentnames "Permanent link")

List of simple names of parent metrics of this metric.

### microStrategyMetricParentQualifiedNames [¶](#microstrategymetricparentqualifiednames "Permanent link")
...
These relationships are inherited from `MicroStrategyMetric`'s supertypes:
...
These relationships are specific to instances of `MicroStrategyMetric` (and all of its subtypes).

### microStrategyAttributes  ([MicroStrategyAttribute](../microstrategyattribute/))[¶](#microstrategyattributes-microstrategyattribute "Permanent link")

Attributes this metric uses.

### microStrategyCubes  ([MicroStrategyCube](../microstrategycube/))[¶](#microstrategycubes-microstrategycube "Permanent link")

Cubes this metric uses.

### microStrategyFacts  ([MicroStrategyFact](../microstrategyfact/))[¶](#microstrategyfacts-microstrategyfact "Permanent link")

Facts this metric uses.

### microStrategyMetricChildren  ([MicroStrategyMetric](./))[¶](#microstrategymetricchildren-microstrategymetric "Permanent link")

Child metrics of this metric.

### microStrategyMetricParents  ([MicroStrategyMetric](./))[¶](#microstrategymetricparents-microstrategymetric "Permanent link")

Parent metrics to this metric.

### microStrategyProject  ([MicroStrategyProject](../microstrategyproject/))[¶](#microstrategyproject-microstrategyproject "Permanent link")

Project in which this metric exists.

### microStrategyReports  ([MicroStrategyReport](../microstrategyreport/))[¶](#microstrategyreports-microstrategyreport "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/microstrategymetric/) to provide us with more information. 

Back to top

[Previous MicroStrategyFact](../microstrategyfact/) [Next MicroStrategyProject](../microstrategyproject/) 
