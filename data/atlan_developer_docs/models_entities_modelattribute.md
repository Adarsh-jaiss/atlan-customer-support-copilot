# Source URL
https://developer.atlan.com/models/entities/modelattribute/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/modelattribute/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/modelattribute.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ModelAttribute - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/modelattribute/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/modelattribute.png
meta-twitter:title: ModelAttribute - Developer
meta-viewport: width=device-width,initial-scale=1
title: ModelAttribute - Developer
-->

[Skip to content](#modelattribute) Developer ModelAttribute Initializing search 
...
ModelAttribute[¶](#modelattribute "Permanent link")
===================================================
...
This is a complete reference for the `ModelAttribute` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ModelAttribute` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `ModelAttribute`'s supertypes (shown above):
...
These attributes are specific to instances of `ModelAttribute` (and all of its subtypes).

### modelAttributeDataType [¶](#modelattributedatatype "Permanent link")

Type of the attribute.

### modelAttributeHasRelationships [¶](#modelattributehasrelationships "Permanent link")

When true, this attribute has relationships with other attributes.

### modelAttributeIsDerived [¶](#modelattributeisderived "Permanent link")

When true, the values in this attribute are derived data.

### modelAttributeIsForeign [¶](#modelattributeisforeign "Permanent link")

When true, this attribute is a foreign key to another entity.

### modelAttributeIsNullable [¶](#modelattributeisnullable "Permanent link")

When true, the values in this attribute can be null.

### modelAttributeIsPrimary [¶](#modelattributeisprimary "Permanent link")

When true, this attribute forms the primary key for the entity.

### modelAttributePrecision [¶](#modelattributeprecision "Permanent link")

Precision of the attribute.

### modelAttributeScale [¶](#modelattributescale "Permanent link")
...
These relationships are inherited from `ModelAttribute`'s supertypes:
...
### modelImplementedAttributes  ([ModelAttribute](./))[¶](#modelimplementedattributes-modelattribute "Permanent link")
...
These relationships are specific to instances of `ModelAttribute` (and all of its subtypes).

### modelAttributeEntities  ([ModelEntity](../modelentity/))[¶](#modelattributeentities-modelentity "Permanent link")

Entity (or versions of an entity) in which this attribute exists.

### modelAttributeImplementedByAssets  ([Catalog](../catalog/))[¶](#modelattributeimplementedbyassets-catalog "Permanent link")

Assets that implement this attribute.

### modelAttributeMappedFromAttributes  ([ModelAttribute](./))[¶](#modelattributemappedfromattributes-modelattribute "Permanent link")

Attributes from which this attribute is mapped.

### modelAttributeMappedToAttributes  ([ModelAttribute](./))[¶](#modelattributemappedtoattributes-modelattribute "Permanent link")

Attributes to which this attribute is mapped.

### modelAttributeRelatedFromAttributes  ([ModelAttributeAssociation](../modelattributeassociation/))[¶](#modelattributerelatedfromattributes-modelattributeassociation "Permanent link")

Association from which this attribute is related.

### modelAttributeRelatedToAttributes  ([ModelAttributeAssociation](../modelattributeassociation/))[¶](#modelattributerelatedtoattributes-modelattributeassociation "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/modelattribute/) to provide us with more information. 

Back to top

[Previous Model](../../model/) [Next ModelAttributeAssociation](../modelattributeassociation/) 
