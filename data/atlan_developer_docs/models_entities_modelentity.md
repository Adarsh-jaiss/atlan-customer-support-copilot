# Source URL
https://developer.atlan.com/models/entities/modelentity/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/modelentity/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/modelentity.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ModelEntity - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/modelentity/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/modelentity.png
meta-twitter:title: ModelEntity - Developer
meta-viewport: width=device-width,initial-scale=1
title: ModelEntity - Developer
-->

[Skip to content](#modelentity) Developer ModelEntity Initializing search 
...
ModelEntity[¶](#modelentity "Permanent link")
=============================================
...
This is a complete reference for the `ModelEntity` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ModelEntity` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class ModelEntity
    link ModelEntity "../modelentity"
    class Model {
        <<abstract>>
    }
    link Model "../model"
...
These attributes are inherited from `ModelEntity`'s supertypes (shown above):
...
These attributes are specific to instances of `ModelEntity` (and all of its subtypes).

### modelEntityAttributeCount [¶](#modelentityattributecount "Permanent link")

Number of attributes in the entity.

### modelEntityGeneralizationName [¶](#modelentitygeneralizationname "Permanent link")

Name of the general entity.

### modelEntityGeneralizationQualifiedName [¶](#modelentitygeneralizationqualifiedname "Permanent link")

Unique identifier for the general entity.

### modelEntitySubjectArea [¶](#modelentitysubjectarea "Permanent link")
...
These relationships are inherited from `ModelEntity`'s supertypes:
...
### modelImplementedEntities  ([ModelEntity](./))[¶](#modelimplementedentities-modelentity "Permanent link")
...
These relationships are specific to instances of `ModelEntity` (and all of its subtypes).

### modelEntityAttributes  ([ModelAttribute](../modelattribute/))[¶](#modelentityattributes-modelattribute "Permanent link")

Individual attributes that make up the entity.

### modelEntityGeneralizationEntity  ([ModelEntity](./))[¶](#modelentitygeneralizationentity-modelentity "Permanent link")

General entity, representing shared characteristics of specialized entities.

### modelEntityImplementedByAssets  ([Catalog](../catalog/))[¶](#modelentityimplementedbyassets-catalog "Permanent link")

Assets that implement this entity.

### modelEntityMappedFromEntities  ([ModelEntity](./))[¶](#modelentitymappedfromentities-modelentity "Permanent link")

Entities from which this entity is mapped.

### modelEntityMappedToEntities  ([ModelEntity](./))[¶](#modelentitymappedtoentities-modelentity "Permanent link")

Entities to which this entity is mapped.

### modelEntityRelatedFromEntities  ([ModelEntityAssociation](../modelentityassociation/))[¶](#modelentityrelatedfromentities-modelentityassociation "Permanent link")

Association from which this entity is related.

### modelEntityRelatedToEntities  ([ModelEntityAssociation](../modelentityassociation/))[¶](#modelentityrelatedtoentities-modelentityassociation "Permanent link")

Association to which this entity is related.

### modelEntitySpecializationEntities  ([ModelEntity](./))[¶](#modelentityspecializationentities-modelentity "Permanent link")

Specialized entities derived from the general entity.

### modelVersions  ([ModelVersion](../modelversion/))[¶](#modelversions-modelversion "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/modelentity/) to provide us with more information. 

Back to top

[Previous ModelDataModel](../modeldatamodel/) [Next ModelEntityAssociation](../modelentityassociation/) 
