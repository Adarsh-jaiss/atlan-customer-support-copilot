# Source URL
https://developer.atlan.com/models/entities/modelentityassociation/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/modelentityassociation/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/modelentityassociation.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ModelEntityAssociation - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/modelentityassociation/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/modelentityassociation.png
meta-twitter:title: ModelEntityAssociation - Developer
meta-viewport: width=device-width,initial-scale=1
title: ModelEntityAssociation - Developer
-->

[Skip to content](#modelentityassociation) Developer ModelEntityAssociation Initializing search 
...
ModelEntityAssociation[¶](#modelentityassociation "Permanent link")
===================================================================
...
This is a complete reference for the `ModelEntityAssociation` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ModelEntityAssociation` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class ModelEntityAssociation
    link ModelEntityAssociation "../modelentityassociation"
    class Model {
        <<abstract>>
    }
    link Model "../model"
...
These attributes are inherited from `ModelEntityAssociation`'s supertypes (shown above):
...
These attributes are specific to instances of `ModelEntityAssociation` (and all of its subtypes).

### modelEntityAssociationCardinality [¶](#modelentityassociationcardinality "Permanent link")

(Deprecated) Cardinality of the data entity association.

### modelEntityAssociationFromLabel [¶](#modelentityassociationfromlabel "Permanent link")

Label when read from the association from which this entity is related.

### modelEntityAssociationFromMaxCardinality [¶](#modelentityassociationfrommaxcardinality "Permanent link")

Maximum cardinality of the data entity from which the association exists.

### modelEntityAssociationFromMinCardinality [¶](#modelentityassociationfrommincardinality "Permanent link")

Minimum cardinality of the data entity from which the association exists.

### modelEntityAssociationFromQualifiedName [¶](#modelentityassociationfromqualifiedname "Permanent link")

Unique name of the association from which this entity is related.

### modelEntityAssociationLabel [¶](#modelentityassociationlabel "Permanent link")

(Deprecated) Label of the data entity association.

### modelEntityAssociationToLabel [¶](#modelentityassociationtolabel "Permanent link")

Label when read from the association to which this entity is related.

### modelEntityAssociationToMaxCardinality [¶](#modelentityassociationtomaxcardinality "Permanent link")

Maximum cardinality of the data entity to which the association exists.

### modelEntityAssociationToMinCardinality [¶](#modelentityassociationtomincardinality "Permanent link")

Minimum cardinality of the data entity to which the association exists.

### modelEntityAssociationToQualifiedName [¶](#modelentityassociationtoqualifiedname "Permanent link")
...
These relationships are inherited from `ModelEntityAssociation`'s supertypes:
...
These relationships are specific to instances of `ModelEntityAssociation` (and all of its subtypes).

### modelEntityAssociationFrom  ([ModelEntity](../modelentity/))[¶](#modelentityassociationfrom-modelentity "Permanent link")

Entity from which this association is related.

### modelEntityAssociationTo  ([ModelEntity](../modelentity/))[¶](#modelentityassociationto-modelentity "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/modelentityassociation/) to provide us with more information. 

Back to top

[Previous ModelEntity](../modelentity/) [Next ModelVersion](../modelversion/) 
