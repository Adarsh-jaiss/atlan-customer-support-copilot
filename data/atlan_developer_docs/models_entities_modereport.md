# Source URL
https://developer.atlan.com/models/entities/modereport/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/modereport/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/modereport.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ModeReport - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/modereport/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/modereport.png
meta-twitter:title: ModeReport - Developer
meta-viewport: width=device-width,initial-scale=1
title: ModeReport - Developer
-->

[Skip to content](#modereport) Developer ModeReport Initializing search 
...
ModeReport[¶](#modereport "Permanent link")
===========================================
...
This is a complete reference for the `ModeReport` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ModeReport` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class ModeReport
    link ModeReport "../modereport"
    class Mode {
        <<abstract>>
    }
    link Mode "../mode"
...
These attributes are inherited from `ModeReport`'s supertypes (shown above):
...
These attributes are specific to instances of `ModeReport` (and all of its subtypes).

### modeChartCount [¶](#modechartcount "Permanent link")

TBC

### modeCollectionToken [¶](#modecollectiontoken "Permanent link")

TBC

### modeIsPublic [¶](#modeispublic "Permanent link")

TBC

### modeIsShared [¶](#modeisshared "Permanent link")

TBC

### modeQueryCount [¶](#modequerycount "Permanent link")

TBC

### modeQueryPreview [¶](#modequerypreview "Permanent link")

TBC

### modeReportPublishedAt [¶](#modereportpublishedat "Permanent link")
...
These relationships are inherited from `ModeReport`'s supertypes:
...
These relationships are specific to instances of `ModeReport` (and all of its subtypes).

### modeCollections  ([ModeCollection](../modecollection/))[¶](#modecollections-modecollection "Permanent link")

TBC

### modeQueries  ([ModeQuery](../modequery/))[¶](#modequeries-modequery "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/modereport/) to provide us with more information. 

Back to top

[Previous ModeQuery](../modequery/) [Next ModeWorkspace](../modeworkspace/) 
