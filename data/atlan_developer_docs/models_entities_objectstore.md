# Source URL
https://developer.atlan.com/models/entities/objectstore/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/objectstore/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/objectstore.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ObjectStore - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/objectstore/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/objectstore.png
meta-twitter:title: ObjectStore - Developer
meta-viewport: width=device-width,initial-scale=1
title: ObjectStore - Developer
-->

[Skip to content](#objectstore) Developer ObjectStore Initializing search 
...
ObjectStore[¶](#objectstore "Permanent link")
=============================================
...
This is a complete reference for the `ObjectStore` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ObjectStore` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `ObjectStore`'s supertypes (shown above):
...
These relationships are inherited from `ObjectStore`'s supertypes:
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/objectstore/) to provide us with more information. 

Back to top

[Previous Insight](../insight/) [Next EventStore](../eventstore/) 
