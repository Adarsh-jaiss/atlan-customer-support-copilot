# Source URL
https://developer.atlan.com/models/entities/powerbicolumn/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/powerbicolumn/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/powerbicolumn.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: PowerBIColumn - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/powerbicolumn/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/powerbicolumn.png
meta-twitter:title: PowerBIColumn - Developer
meta-viewport: width=device-width,initial-scale=1
title: PowerBIColumn - Developer
-->

[Skip to content](#powerbicolumn) Developer PowerBIColumn Initializing search 
...
PowerBIColumn[¶](#powerbicolumn "Permanent link")
=================================================
...
This is a complete reference for the `PowerBIColumn` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`PowerBIColumn` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class PowerBIColumn
    link PowerBIColumn "../powerbicolumn"
    class PowerBI {
        <<abstract>>
    }
...
These attributes are inherited from `PowerBIColumn`'s supertypes (shown above):
...
These attributes are specific to instances of `PowerBIColumn` (and all of its subtypes).

### datasetQualifiedName [¶](#datasetqualifiedname "Permanent link")

Unique name of the dataset in which this column exists.

### powerBIColumnDataCategory [¶](#powerbicolumndatacategory "Permanent link")

Data category that describes the data in this column.

### powerBIColumnDataType [¶](#powerbicolumndatatype "Permanent link")

Data type of this column.

### powerBIColumnSummarizeBy [¶](#powerbicolumnsummarizeby "Permanent link")

Aggregate function to use for summarizing this column.

### powerBISortByColumn [¶](#powerbisortbycolumn "Permanent link")
...
These relationships are inherited from `PowerBIColumn`'s supertypes:
...
These relationships are specific to instances of `PowerBIColumn` (and all of its subtypes).

### table  ([PowerBITable](../powerbitable/))[¶](#table-powerbitable "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/powerbicolumn/) to provide us with more information. 

Back to top

[Previous PowerBI](../../powerbi/) [Next PowerBIDashboard](../powerbidashboard/) 
