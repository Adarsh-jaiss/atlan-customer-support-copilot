# Source URL
https://developer.atlan.com/models/entities/powerbidataflow/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/powerbidataflow/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/powerbidataflow.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: PowerBIDataflow - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/powerbidataflow/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/powerbidataflow.png
meta-twitter:title: PowerBIDataflow - Developer
meta-viewport: width=device-width,initial-scale=1
title: PowerBIDataflow - Developer
-->

[Skip to content](#powerbidataflow) Developer PowerBIDataflow Initializing search 
...
PowerBIDataflow[¶](#powerbidataflow "Permanent link")
=====================================================
...
This is a complete reference for the `PowerBIDataflow` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`PowerBIDataflow` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class PowerBIDataflow
    link PowerBIDataflow "../powerbidataflow"
    class PowerBI {
        <<abstract>>
    }
...
These attributes are inherited from `PowerBIDataflow`'s supertypes (shown above):
...
These attributes are specific to instances of `PowerBIDataflow` (and all of its subtypes).

### powerBIDataflowRefreshScheduleFrequency [¶](#powerbidataflowrefreshschedulefrequency "Permanent link")

Refresh Schedule frequency for a PowerBI Dataflow.

### powerBIDataflowRefreshScheduleTimeZone [¶](#powerbidataflowrefreshscheduletimezone "Permanent link")

Time zone for the refresh schedule set for a PowerBI Dataflow.

### powerBIDataflowRefreshScheduleTimes [¶](#powerbidataflowrefreshscheduletimes "Permanent link")

Time for the refresh schedule set for a PowerBI Dataflow.

### webUrl [¶](#weburl "Permanent link")

Deprecated. See 'sourceUrl' instead.

### workspaceQualifiedName [¶](#workspacequalifiedname "Permanent link")
...
These relationships are inherited from `PowerBIDataflow`'s supertypes:
...
These relationships are specific to instances of `PowerBIDataflow` (and all of its subtypes).

### datasets  ([PowerBIDataset](../powerbidataset/))[¶](#datasets-powerbidataset "Permanent link")

Datasets used by this dataflow.

### powerBIDataflowChildren  ([PowerBIDataflow](./))[¶](#powerbidataflowchildren-powerbidataflow "Permanent link")

Child Dataflows to this PowerBI Dataflow.

### powerBIDataflowEntityColumns  ([PowerBIDataflowEntityColumn](../powerbidataflowentitycolumn/))[¶](#powerbidataflowentitycolumns-powerbidataflowentitycolumn "Permanent link")

PowerBI Dataflow Entity Columns that exist within this Dataflow.

### powerBIDataflowParents  ([PowerBIDataflow](./))[¶](#powerbidataflowparents-powerbidataflow "Permanent link")

Parent Dataflows to this PowerBI Dataflow.

### powerBIDatasources  ([PowerBIDatasource](../powerbidatasource/))[¶](#powerbidatasources-powerbidatasource "Permanent link")

PowerBI Datasources that are associated with this Dataflow.

### powerBIProcesses  ([Process](../../lineage/))[¶](#powerbiprocesses-process "Permanent link")

Lineage process that associates this PowerBI Dataflow.

### tables  ([PowerBITable](../powerbitable/))[¶](#tables-powerbitable "Permanent link")

PowerBI Tables that are associated with this Dataflow.

### workspace  ([PowerBIWorkspace](../powerbiworkspace/))[¶](#workspace-powerbiworkspace "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/powerbidataflow/) to provide us with more information. 

Back to top

[Previous PowerBIDashboard](../powerbidashboard/) [Next PowerBIDataflowEntityColumn](../powerbidataflowentitycolumn/) 
