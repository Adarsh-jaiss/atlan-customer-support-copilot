# Source URL
https://developer.atlan.com/models/entities/powerbidataset/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/powerbidataset/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/powerbidataset.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: PowerBIDataset - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/powerbidataset/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/powerbidataset.png
meta-twitter:title: PowerBIDataset - Developer
meta-viewport: width=device-width,initial-scale=1
title: PowerBIDataset - Developer
-->

[Skip to content](#powerbidataset) Developer PowerBIDataset Initializing search 
...
PowerBIDataset[¶](#powerbidataset "Permanent link")
===================================================
...
This is a complete reference for the `PowerBIDataset` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`PowerBIDataset` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class PowerBIDataset
    link PowerBIDataset "../powerbidataset"
    class PowerBI {
        <<abstract>>
    }
...
These attributes are inherited from `PowerBIDataset`'s supertypes (shown above):
...
These attributes are specific to instances of `PowerBIDataset` (and all of its subtypes).
...
These relationships are inherited from `PowerBIDataset`'s supertypes:
...
These relationships are specific to instances of `PowerBIDataset` (and all of its subtypes).

### dataflows  ([PowerBIDataflow](../powerbidataflow/))[¶](#dataflows-powerbidataflow "Permanent link")

Dataflows that use this dataset.

### datasources  ([PowerBIDatasource](../powerbidatasource/))[¶](#datasources-powerbidatasource "Permanent link")

Datasources that use this dataset.

### reports  ([PowerBIReport](../powerbireport/))[¶](#reports-powerbireport "Permanent link")
...
### tiles  ([PowerBITile](../powerbitile/))[¶](#tiles-powerbitile "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/powerbidataset/) to provide us with more information. 

Back to top

[Previous PowerBIDataflowEntityColumn](../powerbidataflowentitycolumn/) [Next PowerBIDatasource](../powerbidatasource/) 
