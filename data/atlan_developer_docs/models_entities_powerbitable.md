# Source URL
https://developer.atlan.com/models/entities/powerbitable/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/powerbitable/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/powerbitable.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: PowerBITable - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/powerbitable/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/powerbitable.png
meta-twitter:title: PowerBITable - Developer
meta-viewport: width=device-width,initial-scale=1
title: PowerBITable - Developer
-->

[Skip to content](#powerbitable) Developer PowerBITable Initializing search 
...
PowerBITable[¶](#powerbitable "Permanent link")
===============================================
...
This is a complete reference for the `PowerBITable` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`PowerBITable` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class PowerBITable
    link PowerBITable "../powerbitable"
    class PowerBI {
        <<abstract>>
    }
...
These attributes are inherited from `PowerBITable`'s supertypes (shown above):
...
These attributes are specific to instances of `PowerBITable` (and all of its subtypes).

### dataflowQualifiedNames [¶](#dataflowqualifiednames "Permanent link")

List of qualified names of associated Power BI Dataflows.

### datasetQualifiedName [¶](#datasetqualifiedname "Permanent link")

Unique name of the dataset in which this table exists.

### powerBITableColumnCount [¶](#powerbitablecolumncount "Permanent link")

Number of columns in this table.

### powerBITableMeasureCount [¶](#powerbitablemeasurecount "Permanent link")

Number of measures in this table.

### powerBITableSourceExpressions [¶](#powerbitablesourceexpressions "Permanent link")
...
These relationships are inherited from `PowerBITable`'s supertypes:
...
These relationships are specific to instances of `PowerBITable` (and all of its subtypes).

### columns  ([PowerBIColumn](../powerbicolumn/))[¶](#columns-powerbicolumn "Permanent link")

Columns that exist within this table.

### dataflows  ([PowerBIDataflow](../powerbidataflow/))[¶](#dataflows-powerbidataflow "Permanent link")

PowerBI Dataflow that is associated with this PowerBI Table.

### dataset  ([PowerBIDataset](../powerbidataset/))[¶](#dataset-powerbidataset "Permanent link")

Dataset in which this table exists.

### measures  ([PowerBIMeasure](../powerbimeasure/))[¶](#measures-powerbimeasure "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/powerbitable/) to provide us with more information. 

Back to top

[Previous PowerBIReport](../powerbireport/) [Next PowerBITile](../powerbitile/) 
