# Source URL
https://developer.atlan.com/models/entities/presetworkspace/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/presetworkspace/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/presetworkspace.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: PresetWorkspace - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/presetworkspace/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/presetworkspace.png
meta-twitter:title: PresetWorkspace - Developer
meta-viewport: width=device-width,initial-scale=1
title: PresetWorkspace - Developer
-->

[Skip to content](#presetworkspace) Developer PresetWorkspace Initializing search 
...
This is a complete reference for the `PresetWorkspace` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`PresetWorkspace` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class PresetWorkspace
    link PresetWorkspace "../presetworkspace"
    class Preset {
        <<abstract>>
    }
    link Preset "../preset"
...
These attributes are inherited from `PresetWorkspace`'s supertypes (shown above):
...
These attributes are specific to instances of `PresetWorkspace` (and all of its subtypes).

### presetWorkspaceClusterId [¶](#presetworkspaceclusterid "Permanent link")

TBC

### presetWorkspaceDashboardCount [¶](#presetworkspacedashboardcount "Permanent link")

TBC

### presetWorkspaceDatasetCount [¶](#presetworkspacedatasetcount "Permanent link")

TBC

### presetWorkspaceDeploymentId [¶](#presetworkspacedeploymentid "Permanent link")

TBC

### presetWorkspaceHostname [¶](#presetworkspacehostname "Permanent link")

TBC

### presetWorkspaceIsInMaintenanceMode [¶](#presetworkspaceisinmaintenancemode "Permanent link")

TBC

### presetWorkspacePublicDashboardsAllowed [¶](#presetworkspacepublicdashboardsallowed "Permanent link")

TBC

### presetWorkspaceRegion [¶](#presetworkspaceregion "Permanent link")

TBC

### presetWorkspaceStatus [¶](#presetworkspacestatus "Permanent link")
...
These relationships are inherited from `PresetWorkspace`'s supertypes:
...
These relationships are specific to instances of `PresetWorkspace` (and all of its subtypes).

### presetDashboards  ([PresetDashboard](../presetdashboard/))[¶](#presetdashboards-presetdashboard "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/presetworkspace/) to provide us with more information. 

Back to top

[Previous PresetDataset](../presetdataset/) [Next Qlik](../../qlik/) 
