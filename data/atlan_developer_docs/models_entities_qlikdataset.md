# Source URL
https://developer.atlan.com/models/entities/qlikdataset/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/qlikdataset/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/qlikdataset.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: QlikDataset - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/qlikdataset/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/qlikdataset.png
meta-twitter:title: QlikDataset - Developer
meta-viewport: width=device-width,initial-scale=1
title: QlikDataset - Developer
-->

[Skip to content](#qlikdataset) Developer QlikDataset Initializing search 
...
QlikDataset[¶](#qlikdataset "Permanent link")
=============================================
...
This is a complete reference for the `QlikDataset` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`QlikDataset` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class QlikDataset
    link QlikDataset "../qlikdataset"
    class Qlik {
        <<abstract>>
    }
    link Qlik "../qlik"
...
These attributes are inherited from `QlikDataset`'s supertypes (shown above):
...
These attributes are specific to instances of `QlikDataset` (and all of its subtypes).

### qlikDatasetSubtype [¶](#qlikdatasetsubtype "Permanent link")

Subtype this dataset asset.

### qlikDatasetTechnicalName [¶](#qlikdatasettechnicalname "Permanent link")

Technical name of this asset.

### qlikDatasetType [¶](#qlikdatasettype "Permanent link")

Type of this data asset, for example: qix\-df, snowflake, etc.

### qlikDatasetUri [¶](#qlikdataseturi "Permanent link")
...
These relationships are inherited from `QlikDataset`'s supertypes:
...
These relationships are specific to instances of `QlikDataset` (and all of its subtypes).
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/qlikdataset/) to provide us with more information. 

Back to top

[Previous QlikChart](../qlikchart/) [Next QlikSheet](../qliksheet/) 
