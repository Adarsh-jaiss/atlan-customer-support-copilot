# Source URL
https://developer.atlan.com/models/entities/query/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/query/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/query.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Query - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/query/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/query.png
meta-twitter:title: Query - Developer
meta-viewport: width=device-width,initial-scale=1
title: Query - Developer
-->

[Skip to content](#query) Developer Query Initializing search 
...
This is a complete reference for the `Query` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`Query` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `Query`'s supertypes (shown above):
...
These attributes are specific to instances of `Query` (and all of its subtypes).

### collectionQualifiedName [¶](#collectionqualifiedname "Permanent link")

TBC

### defaultDatabaseQualifiedName [¶](#defaultdatabasequalifiedname "Permanent link")

TBC

### defaultSchemaQualifiedName [¶](#defaultschemaqualifiedname "Permanent link")

TBC

### isPrivate [¶](#isprivate "Permanent link")

TBC

### isSqlSnippet [¶](#issqlsnippet "Permanent link")

TBC

### isVisualQuery [¶](#isvisualquery "Permanent link")

TBC

### longRawQuery [¶](#longrawquery "Permanent link")

TBC

### parentQualifiedName [¶](#parentqualifiedname "Permanent link")

TBC

### rawQuery [¶](#rawquery "Permanent link")

TBC

### rawQueryText [¶](#rawquerytext "Permanent link")

TBC

### variablesSchemaBase64 [¶](#variablesschemabase64 "Permanent link")

TBC

### visualBuilderSchemaBase64 [¶](#visualbuilderschemabase64 "Permanent link")
...
These relationships are inherited from `Query`'s supertypes:
...
These relationships are specific to instances of `Query` (and all of its subtypes).

### columns  ([Column](../column/))[¶](#columns-column "Permanent link")

TBC

### parent  ([Namespace](../namespace/))[¶](#parent-namespace "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/query/) to provide us with more information. 

Back to top

[Previous Column](../column/) [Next TablePartition](../tablepartition/) 
