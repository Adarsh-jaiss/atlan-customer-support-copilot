# Source URL
https://developer.atlan.com/models/entities/quicksightanalysis/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/quicksightanalysis/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/quicksightanalysis.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: QuickSightAnalysis - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/quicksightanalysis/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/quicksightanalysis.png
meta-twitter:title: QuickSightAnalysis - Developer
meta-viewport: width=device-width,initial-scale=1
title: QuickSightAnalysis - Developer
-->

[Skip to content](#quicksightanalysis) Developer QuickSightAnalysis Initializing search 
...
This is a complete reference for the `QuickSightAnalysis` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`QuickSightAnalysis` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `QuickSightAnalysis`'s supertypes (shown above):
...
These attributes are specific to instances of `QuickSightAnalysis` (and all of its subtypes).

### quickSightAnalysisCalculatedFields [¶](#quicksightanalysiscalculatedfields "Permanent link")

List of field names calculated by this analysis.

### quickSightAnalysisFilterGroups [¶](#quicksightanalysisfiltergroups "Permanent link")

List of filter groups used for this analysis.

### quickSightAnalysisParameterDeclarations [¶](#quicksightanalysisparameterdeclarations "Permanent link")

List of parameters used for this analysis.

### quickSightAnalysisStatus [¶](#quicksightanalysisstatus "Permanent link")

Status of this analysis, for example: CREATION\_IN\_PROGRESS, UPDATE\_SUCCESSFUL, etc.
...
These relationships are inherited from `QuickSightAnalysis`'s supertypes:
...
These relationships are specific to instances of `QuickSightAnalysis` (and all of its subtypes).

### quickSightAnalysisFolders  ([QuickSightFolder](../quicksightfolder/))[¶](#quicksightanalysisfolders-quicksightfolder "Permanent link")

TBC

### quickSightAnalysisVisuals  ([QuickSightAnalysisVisual](../quicksightanalysisvisual/))[¶](#quicksightanalysisvisuals-quicksightanalysisvisual "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/quicksightanalysis/) to provide us with more information. 

Back to top

[Previous QuickSight](../../quicksight/) [Next QuickSightAnalysisVisual](../quicksightanalysisvisual/) 
