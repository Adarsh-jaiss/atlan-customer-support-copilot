# Source URL
https://developer.atlan.com/models/entities/readme/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/readme/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/readme.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Readme - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/readme/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/readme.png
meta-twitter:title: Readme - Developer
meta-viewport: width=device-width,initial-scale=1
title: Readme - Developer
-->

[Skip to content](#readme) Developer Readme Initializing search 
...
This is a complete reference for the `Readme` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`Readme` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `Readme`'s supertypes (shown above):
...
These relationships are inherited from `Readme`'s supertypes:
...
### readme  ([Readme](./))[¶](#readme-readme "Permanent link")
...
These relationships are specific to instances of `Readme` (and all of its subtypes).

### asset  ([Asset](../asset/))[¶](#asset-asset "Permanent link")

Asset that this README describes.

### seeAlso  ([Readme](./))[¶](#seealso-readme "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/readme/) to provide us with more information. 

Back to top

[Previous File](../file/) [Next ReadmeTemplate](../readmetemplate/) 
