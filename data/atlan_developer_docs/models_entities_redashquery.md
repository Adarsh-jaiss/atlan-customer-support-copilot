# Source URL
https://developer.atlan.com/models/entities/redashquery/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/redashquery/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/redashquery.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: RedashQuery - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/redashquery/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/redashquery.png
meta-twitter:title: RedashQuery - Developer
meta-viewport: width=device-width,initial-scale=1
title: RedashQuery - Developer
-->

[Skip to content](#redashquery) Developer RedashQuery Initializing search 
...
RedashQuery[¶](#redashquery "Permanent link")
=============================================
...
This is a complete reference for the `RedashQuery` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`RedashQuery` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class RedashQuery
    link RedashQuery "../redashquery"
    class Redash {
        <<abstract>>
    }
    link Redash "../redash"
...
These attributes are inherited from `RedashQuery`'s supertypes (shown above):
...
These attributes are specific to instances of `RedashQuery` (and all of its subtypes).

### redashQueryLastExecutedAt [¶](#redashquerylastexecutedat "Permanent link")

Time (epoch) when this query was last executed, in milliseconds.

### redashQueryLastExecutionRuntime [¶](#redashquerylastexecutionruntime "Permanent link")

Elapsed time of the last execution of this query.

### redashQueryParameters [¶](#redashqueryparameters "Permanent link")

Parameters of this query.

### redashQuerySQL [¶](#redashquerysql "Permanent link")

SQL code of this query.

### redashQuerySchedule [¶](#redashqueryschedule "Permanent link")

Schedule for this query.

### redashQueryScheduleHumanized [¶](#redashqueryschedulehumanized "Permanent link")
...
These relationships are inherited from `RedashQuery`'s supertypes:
...
These relationships are specific to instances of `RedashQuery` (and all of its subtypes).

### redashVisualizations  ([RedashVisualization](../redashvisualization/))[¶](#redashvisualizations-redashvisualization "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/redashquery/) to provide us with more information. 

Back to top

[Previous RedashDashboard](../redashdashboard/) [Next RedashVisualization](../redashvisualization/) 
