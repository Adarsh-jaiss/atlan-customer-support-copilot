# Source URL
https://developer.atlan.com/models/entities/salesforcefield/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/salesforcefield/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/salesforcefield.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: SalesforceField - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/salesforcefield/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/salesforcefield.png
meta-twitter:title: SalesforceField - Developer
meta-viewport: width=device-width,initial-scale=1
title: SalesforceField - Developer
-->

[Skip to content](#salesforcefield) Developer SalesforceField Initializing search 
...
SalesforceField[¶](#salesforcefield "Permanent link")
=====================================================
...
This is a complete reference for the `SalesforceField` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`SalesforceField` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class SalesforceField
    link SalesforceField "../salesforcefield"
    class Salesforce {
        <<abstract>>
    }
...
These attributes are inherited from `SalesforceField`'s supertypes (shown above):
...
These attributes are specific to instances of `SalesforceField` (and all of its subtypes).

### dataType [¶](#datatype "Permanent link")

Data type of values in this field.

### defaultValueFormula [¶](#defaultvalueformula "Permanent link")
...
### inlineHelpText [¶](#inlinehelptext "Permanent link")

Help text for this field.

### isCalculated [¶](#iscalculated "Permanent link")

Whether this field is calculated (true) or not (false).

### isCaseSensitive [¶](#iscasesensitive "Permanent link")

Whether this field is case sensitive (true) or in\-sensitive (false).

### isEncrypted [¶](#isencrypted "Permanent link")
...
### isPolymorphicForeignKey [¶](#ispolymorphicforeignkey "Permanent link")

Whether this field references a record of multiple objects (true) or not (false).

### isUnique [¶](#isunique "Permanent link")
...
### objectQualifiedName [¶](#objectqualifiedname "Permanent link")
...
### picklistValues [¶](#picklistvalues "Permanent link")
...
These relationships are inherited from `SalesforceField`'s supertypes:
...
These relationships are specific to instances of `SalesforceField` (and all of its subtypes).

### lookupObjects  ([SalesforceObject](../salesforceobject/))[¶](#lookupobjects-salesforceobject "Permanent link")

TBC

### object  ([SalesforceObject](../salesforceobject/))[¶](#object-salesforceobject "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/salesforcefield/) to provide us with more information. 

Back to top

[Previous SalesforceDashboard](../salesforcedashboard/) [Next SalesforceObject](../salesforceobject/) 
