# Source URL
https://developer.atlan.com/models/entities/salesforceobject/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/salesforceobject/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/salesforceobject.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: SalesforceObject - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/salesforceobject/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/salesforceobject.png
meta-twitter:title: SalesforceObject - Developer
meta-viewport: width=device-width,initial-scale=1
title: SalesforceObject - Developer
-->

[Skip to content](#salesforceobject) Developer SalesforceObject Initializing search 
...
SalesforceObject[¶](#salesforceobject "Permanent link")
=======================================================
...
This is a complete reference for the `SalesforceObject` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`SalesforceObject` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class SalesforceObject
    link SalesforceObject "../salesforceobject"
    class Salesforce {
        <<abstract>>
    }
...
These attributes are inherited from `SalesforceObject`'s supertypes (shown above):
...
These attributes are specific to instances of `SalesforceObject` (and all of its subtypes).

### fieldCount [¶](#fieldcount "Permanent link")

Number of fields in this object.

### isCustom [¶](#iscustom "Permanent link")

Whether this object is a custom object (true) or not (false).

### isMergable [¶](#ismergable "Permanent link")

Whether this object is mergable (true) or not (false).

### isQueryable [¶](#isqueryable "Permanent link")
...
These relationships are inherited from `SalesforceObject`'s supertypes:
...
These relationships are specific to instances of `SalesforceObject` (and all of its subtypes).

### fields  ([SalesforceField](../salesforcefield/))[¶](#fields-salesforcefield "Permanent link")

Fields that exist within this object.

### lookupFields  ([SalesforceField](../salesforcefield/))[¶](#lookupfields-salesforcefield "Permanent link")

TBC

### organization  ([SalesforceOrganization](../salesforceorganization/))[¶](#organization-salesforceorganization "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/salesforceobject/) to provide us with more information. 

Back to top

[Previous SalesforceField](../salesforcefield/) [Next SalesforceOrganization](../salesforceorganization/) 
