# Source URL
https://developer.atlan.com/models/entities/sigmadataelement/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/sigmadataelement/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/sigmadataelement.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: SigmaDataElement - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/sigmadataelement/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/sigmadataelement.png
meta-twitter:title: SigmaDataElement - Developer
meta-viewport: width=device-width,initial-scale=1
title: SigmaDataElement - Developer
-->

[Skip to content](#sigmadataelement) Developer SigmaDataElement Initializing search 
...
SigmaDataElement[¶](#sigmadataelement "Permanent link")
=======================================================
...
This is a complete reference for the `SigmaDataElement` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`SigmaDataElement` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class SigmaDataElement
    link SigmaDataElement "../sigmadataelement"
    class Sigma {
        <<abstract>>
    }
    link Sigma "../sigma"
...
These attributes are inherited from `SigmaDataElement`'s supertypes (shown above):
...
These attributes are specific to instances of `SigmaDataElement` (and all of its subtypes).

### sigmaDataElementFieldCount [¶](#sigmadataelementfieldcount "Permanent link")

Number of fields in this data element.

### sigmaDataElementQuery [¶](#sigmadataelementquery "Permanent link")

TBC

### sigmaDataElementType [¶](#sigmadataelementtype "Permanent link")
...
These relationships are inherited from `SigmaDataElement`'s supertypes:
...
These relationships are specific to instances of `SigmaDataElement` (and all of its subtypes).

### sigmaDataElementFields  ([SigmaDataElementField](../sigmadataelementfield/))[¶](#sigmadataelementfields-sigmadataelementfield "Permanent link")

Data element fields that exist in this data element.

### sigmaPage  ([SigmaPage](../sigmapage/))[¶](#sigmapage-sigmapage "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/sigmadataelement/) to provide us with more information. 

Back to top

[Previous SigmaPage](../sigmapage/) [Next SigmaDataElementField](../sigmadataelementfield/) 
