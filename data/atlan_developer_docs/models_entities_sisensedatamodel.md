# Source URL
https://developer.atlan.com/models/entities/sisensedatamodel/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/sisensedatamodel/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/sisensedatamodel.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: SisenseDatamodel - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/sisensedatamodel/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/sisensedatamodel.png
meta-twitter:title: SisenseDatamodel - Developer
meta-viewport: width=device-width,initial-scale=1
title: SisenseDatamodel - Developer
-->

[Skip to content](#sisensedatamodel) Developer SisenseDatamodel Initializing search 
...
SisenseDatamodel[¶](#sisensedatamodel "Permanent link")
=======================================================
...
This is a complete reference for the `SisenseDatamodel` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`SisenseDatamodel` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `SisenseDatamodel`'s supertypes (shown above):
...
These attributes are specific to instances of `SisenseDatamodel` (and all of its subtypes).

### sisenseDatamodelLastBuildTime [¶](#sisensedatamodellastbuildtime "Permanent link")

Time (epoch) when this datamodel was last built, in milliseconds.

### sisenseDatamodelLastPublishTime [¶](#sisensedatamodellastpublishtime "Permanent link")

Time (epoch) when this datamodel was last published, in milliseconds.

### sisenseDatamodelLastSuccessfulBuildTime [¶](#sisensedatamodellastsuccessfulbuildtime "Permanent link")

Time (epoch) when this datamodel was last built successfully, in milliseconds.

### sisenseDatamodelRelationType [¶](#sisensedatamodelrelationtype "Permanent link")
...
### sisenseDatamodelRevision [¶](#sisensedatamodelrevision "Permanent link")

Revision of this datamodel.

### sisenseDatamodelServer [¶](#sisensedatamodelserver "Permanent link")

Hostname of the server on which this datamodel was created.

### sisenseDatamodelTableCount [¶](#sisensedatamodeltablecount "Permanent link")

Number of tables in this datamodel.

### sisenseDatamodelType [¶](#sisensedatamodeltype "Permanent link")
...
These relationships are inherited from `SisenseDatamodel`'s supertypes:
...
These relationships are specific to instances of `SisenseDatamodel` (and all of its subtypes).

### sisenseDashboards  ([SisenseDashboard](../sisensedashboard/))[¶](#sisensedashboards-sisensedashboard "Permanent link")

TBC

### sisenseDatamodelTables  ([SisenseDatamodelTable](../sisensedatamodeltable/))[¶](#sisensedatamodeltables-sisensedatamodeltable "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/sisensedatamodel/) to provide us with more information. 

Back to top

[Previous SisenseDashboard](../sisensedashboard/) [Next SisenseDatamodelTable](../sisensedatamodeltable/) 
