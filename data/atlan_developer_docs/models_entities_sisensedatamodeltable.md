# Source URL
https://developer.atlan.com/models/entities/sisensedatamodeltable/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/sisensedatamodeltable/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/sisensedatamodeltable.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: SisenseDatamodelTable - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/sisensedatamodeltable/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/sisensedatamodeltable.png
meta-twitter:title: SisenseDatamodelTable - Developer
meta-viewport: width=device-width,initial-scale=1
title: SisenseDatamodelTable - Developer
-->

[Skip to content](#sisensedatamodeltable) Developer SisenseDatamodelTable Initializing search 
...
SisenseDatamodelTable[¶](#sisensedatamodeltable "Permanent link")
=================================================================
...
This is a complete reference for the `SisenseDatamodelTable` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`SisenseDatamodelTable` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class SisenseDatamodelTable
    link SisenseDatamodelTable "../sisensedatamodeltable"
    class Sisense {
        <<abstract>>
    }
...
These attributes are inherited from `SisenseDatamodelTable`'s supertypes (shown above):
...
These attributes are specific to instances of `SisenseDatamodelTable` (and all of its subtypes).

### sisenseDatamodelQualifiedName [¶](#sisensedatamodelqualifiedname "Permanent link")

Unique name of the datamodel in which this datamodel table exists.

### sisenseDatamodelTableColumnCount [¶](#sisensedatamodeltablecolumncount "Permanent link")

Number of columns present in this datamodel table.

### sisenseDatamodelTableExpression [¶](#sisensedatamodeltableexpression "Permanent link")

SQL expression of this datamodel table.

### sisenseDatamodelTableIsHidden [¶](#sisensedatamodeltableishidden "Permanent link")

Whether this datamodel table is hidden in Sisense (true) or not (false).

### sisenseDatamodelTableIsMaterialized [¶](#sisensedatamodeltableismaterialized "Permanent link")

Whether this datamodel table is materialised (true) or not (false).

### sisenseDatamodelTableLiveQuerySettings [¶](#sisensedatamodeltablelivequerysettings "Permanent link")

JSON specifying the LiveQuery settings of this datamodel table.

### sisenseDatamodelTableSchedule [¶](#sisensedatamodeltableschedule "Permanent link")

JSON specifying the refresh schedule of this datamodel table.

### sisenseDatamodelTableType [¶](#sisensedatamodeltabletype "Permanent link")
...
These relationships are inherited from `SisenseDatamodelTable`'s supertypes:
...
These relationships are specific to instances of `SisenseDatamodelTable` (and all of its subtypes).

### sisenseDatamodel  ([SisenseDatamodel](../sisensedatamodel/))[¶](#sisensedatamodel-sisensedatamodel "Permanent link")

Datamodel in which this datamodel table exists.

### sisenseWidgets  ([SisenseWidget](../sisensewidget/))[¶](#sisensewidgets-sisensewidget "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/sisensedatamodeltable/) to provide us with more information. 

Back to top

[Previous SisenseDatamodel](../sisensedatamodel/) [Next SisenseFolder](../sisensefolder/) 
