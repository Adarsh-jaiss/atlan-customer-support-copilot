# Source URL
https://developer.atlan.com/models/entities/snowflakepipe/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/snowflakepipe/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/snowflakepipe.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: SnowflakePipe - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/snowflakepipe/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/snowflakepipe.png
meta-twitter:title: SnowflakePipe - Developer
meta-viewport: width=device-width,initial-scale=1
title: SnowflakePipe - Developer
-->

[Skip to content](#snowflakepipe) Developer SnowflakePipe Initializing search 
...
SnowflakePipe[¶](#snowflakepipe "Permanent link")
=================================================
...
This is a complete reference for the `SnowflakePipe` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`SnowflakePipe` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class SnowflakePipe
    link SnowflakePipe "../snowflakepipe"
    class SQL {
        <<abstract>>
    }
    link SQL "../sql"
...
These attributes are inherited from `SnowflakePipe`'s supertypes (shown above):
...
These attributes are specific to instances of `SnowflakePipe` (and all of its subtypes).

### definition [¶](#definition "Permanent link")

SQL definition of this pipe.

### snowflakePipeIsAutoIngestEnabled [¶](#snowflakepipeisautoingestenabled "Permanent link")

Whether auto\-ingest is enabled for this pipe (true) or not (false).

### snowflakePipeNotificationChannelName [¶](#snowflakepipenotificationchannelname "Permanent link")
...
These relationships are inherited from `SnowflakePipe`'s supertypes:
...
These relationships are specific to instances of `SnowflakePipe` (and all of its subtypes).

### atlanSchema  ([Schema](../schema/))[¶](#atlanschema-schema "Permanent link")

Schema in which this Snowflake pipe exists. (1\)
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/snowflakepipe/) to provide us with more information. 

Back to top

[Previous SnowflakeDynamicTable](../snowflakedynamictable/) [Next SnowflakeStream](../snowflakestream/) 
