# Source URL
https://developer.atlan.com/models/entities/sodacheck/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/sodacheck/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/sodacheck.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: SodaCheck - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/sodacheck/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/sodacheck.png
meta-twitter:title: SodaCheck - Developer
meta-viewport: width=device-width,initial-scale=1
title: SodaCheck - Developer
-->

[Skip to content](#sodacheck) Developer SodaCheck Initializing search 
...
SodaCheck[¶](#sodacheck "Permanent link")
=========================================
...
This is a complete reference for the `SodaCheck` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`SodaCheck` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class SodaCheck
    link SodaCheck "../sodacheck"
    class Soda {
        <<abstract>>
    }
    link Soda "../soda"
...
These attributes are inherited from `SodaCheck`'s supertypes (shown above):
...
These attributes are specific to instances of `SodaCheck` (and all of its subtypes).

### sodaCheckDefinition [¶](#sodacheckdefinition "Permanent link")

Definition of the check in Soda.

### sodaCheckEvaluationStatus [¶](#sodacheckevaluationstatus "Permanent link")

Status of the check in Soda.

### sodaCheckId [¶](#sodacheckid "Permanent link")

Identifier of the check in Soda.

### sodaCheckIncidentCount [¶](#sodacheckincidentcount "Permanent link")

TBC

### sodaCheckLastScanAt [¶](#sodachecklastscanat "Permanent link")
...
These relationships are inherited from `SodaCheck`'s supertypes:
...
### sodaChecks  ([SodaCheck](./))[¶](#sodachecks-sodacheck "Permanent link")
...
These relationships are specific to instances of `SodaCheck` (and all of its subtypes).

### sodaCheckAssets  ([Asset](../asset/))[¶](#sodacheckassets-asset "Permanent link")

TBC

### sodaCheckColumns  ([Column](../column/))[¶](#sodacheckcolumns-column "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/sodacheck/) to provide us with more information. 

Back to top

[Previous Soda](../../soda/) [Next Spark](../../spark/) 
