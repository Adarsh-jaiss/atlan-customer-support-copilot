# Source URL
https://developer.atlan.com/models/entities/stakeholder/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/stakeholder/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/stakeholder.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Stakeholder - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/stakeholder/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/stakeholder.png
meta-twitter:title: Stakeholder - Developer
meta-viewport: width=device-width,initial-scale=1
title: Stakeholder - Developer
-->

[Skip to content](#stakeholder) Developer Stakeholder Initializing search 
...
Stakeholder[¶](#stakeholder "Permanent link")
=============================================
...
This is a complete reference for the `Stakeholder` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`Stakeholder` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `Stakeholder`'s supertypes (shown above):
...
### personaGroups [¶](#personagroups "Permanent link")

TBC

### personaUsers [¶](#personausers "Permanent link")

TBC

### roleId [¶](#roleid "Permanent link")

TBC

These attributes are specific to instances of `Stakeholder` (and all of its subtypes).

### stakeholderDomainQualifiedName [¶](#stakeholderdomainqualifiedname "Permanent link")

TBC

### stakeholderTitleGuid [¶](#stakeholdertitleguid "Permanent link")
...
These relationships are inherited from `Stakeholder`'s supertypes:
...
### policies  ([AuthPolicy](../authpolicy/))[¶](#policies-authpolicy "Permanent link")

TBC

These relationships are specific to instances of `Stakeholder` (and all of its subtypes).

### stakeholderDataDomain  ([DataDomain](../datadomain/))[¶](#stakeholderdatadomain-datadomain "Permanent link")

Domain assigned to the Stakeholder

### stakeholderTitle  ([StakeholderTitle](../stakeholdertitle/))[¶](#stakeholdertitle-stakeholdertitle "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/stakeholder/) to provide us with more information. 

Back to top

[Previous DataContract](../datacontract/) [Next StakeholderTitle](../stakeholdertitle/) 
