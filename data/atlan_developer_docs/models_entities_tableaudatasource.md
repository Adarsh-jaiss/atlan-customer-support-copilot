# Source URL
https://developer.atlan.com/models/entities/tableaudatasource/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/tableaudatasource/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/tableaudatasource.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: TableauDatasource - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/tableaudatasource/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/tableaudatasource.png
meta-twitter:title: TableauDatasource - Developer
meta-viewport: width=device-width,initial-scale=1
title: TableauDatasource - Developer
-->

[Skip to content](#tableaudatasource) Developer TableauDatasource Initializing search 
...
TableauDatasource[¶](#tableaudatasource "Permanent link")
=========================================================
...
This is a complete reference for the `TableauDatasource` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`TableauDatasource` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class TableauDatasource
    link TableauDatasource "../tableaudatasource"
    class Tableau {
        <<abstract>>
    }
...
These attributes are inherited from `TableauDatasource`'s supertypes (shown above):
...
These attributes are specific to instances of `TableauDatasource` (and all of its subtypes).

### certificationNote [¶](#certificationnote "Permanent link")

Notes related to this datasource being cerfified, in Tableau.

### certifier [¶](#certifier "Permanent link")

Users that have marked this datasource as cerified, in Tableau.

### certifierDisplayName [¶](#certifierdisplayname "Permanent link")

Name of the user who cerified this datasource, in Tableau.

### hasExtracts [¶](#hasextracts "Permanent link")

Whether this datasource has extracts (true) or not (false).

### isCertified [¶](#iscertified "Permanent link")

Whether this datasource is certified in Tableau (true) or not (false).

### isPublished [¶](#ispublished "Permanent link")
...
### upstreamDatasources [¶](#upstreamdatasources "Permanent link")
...
These relationships are inherited from `TableauDatasource`'s supertypes:
...
These relationships are specific to instances of `TableauDatasource` (and all of its subtypes).

### fields  ([TableauCalculatedField](../tableaucalculatedfield/))[¶](#fields-tableaucalculatedfield "Permanent link")

Fields that exist within this datasource.

### project  ([TableauProject](../tableauproject/))[¶](#project-tableauproject "Permanent link")

Project in which this datasource exists.

### workbook  ([TableauWorkbook](../tableauworkbook/))[¶](#workbook-tableauworkbook "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/tableaudatasource/) to provide us with more information. 

Back to top

[Previous TableauDashboard](../tableaudashboard/) [Next TableauDatasourceField](../tableaudatasourcefield/) 
