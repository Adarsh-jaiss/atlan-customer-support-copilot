# Source URL
https://developer.atlan.com/models/entities/tableaudatasourcefield/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/tableaudatasourcefield/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/tableaudatasourcefield.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: TableauDatasourceField - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/tableaudatasourcefield/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/tableaudatasourcefield.png
meta-twitter:title: TableauDatasourceField - Developer
meta-viewport: width=device-width,initial-scale=1
title: TableauDatasourceField - Developer
-->

[Skip to content](#tableaudatasourcefield) Developer TableauDatasourceField Initializing search 
...
TableauDatasourceField[¶](#tableaudatasourcefield "Permanent link")
===================================================================
...
This is a complete reference for the `TableauDatasourceField` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`TableauDatasourceField` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class TableauDatasourceField
    link TableauDatasourceField "../tableaudatasourcefield"
    class Tableau {
        <<abstract>>
    }
...
These attributes are inherited from `TableauDatasourceField`'s supertypes (shown above):
...
These attributes are specific to instances of `TableauDatasourceField` (and all of its subtypes).

### datasourceFieldType [¶](#datasourcefieldtype "Permanent link")

Type of this datasource field.

### datasourceQualifiedName [¶](#datasourcequalifiedname "Permanent link")

Unique name of the datasource in which this datasource field exists.

### fullyQualifiedName [¶](#fullyqualifiedname "Permanent link")

Name used internally in Tableau to uniquely identify this field.

### projectHierarchy [¶](#projecthierarchy "Permanent link")

List of top\-level projects and their nested child projects.

### projectQualifiedName [¶](#projectqualifiedname "Permanent link")

Unique name of the project in which this datasource field exists.

### siteQualifiedName [¶](#sitequalifiedname "Permanent link")

Unique name of the site in which this datasource field exists.

### tableauDatasourceFieldBinSize [¶](#tableaudatasourcefieldbinsize "Permanent link")

Bin size of this field.

### tableauDatasourceFieldDataCategory [¶](#tableaudatasourcefielddatacategory "Permanent link")

Data category of this field.

### tableauDatasourceFieldDataType [¶](#tableaudatasourcefielddatatype "Permanent link")

Data type of this field.

### tableauDatasourceFieldFormula [¶](#tableaudatasourcefieldformula "Permanent link")

Formula for this field.

### tableauDatasourceFieldRole [¶](#tableaudatasourcefieldrole "Permanent link")

Role of this field, for example: 'dimension', 'measure', or 'unknown'.

### topLevelProjectQualifiedName [¶](#toplevelprojectqualifiedname "Permanent link")

Unique name of the top\-level project in which this datasource field exists.

### upstreamColumns [¶](#upstreamcolumns "Permanent link")

Columns upstream to this field.

### upstreamFields [¶](#upstreamfields "Permanent link")

Fields upstream to this field.

### upstreamTables [¶](#upstreamtables "Permanent link")

Tables upstream to this datasource field.

### workbookQualifiedName [¶](#workbookqualifiedname "Permanent link")
...
These relationships are inherited from `TableauDatasourceField`'s supertypes:
...
These relationships are specific to instances of `TableauDatasourceField` (and all of its subtypes).

### datasource  ([TableauDatasource](../tableaudatasource/))[¶](#datasource-tableaudatasource "Permanent link")

Datasource in which this field exists.

### worksheets  ([TableauWorksheet](../tableauworksheet/))[¶](#worksheets-tableauworksheet "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/tableaudatasourcefield/) to provide us with more information. 

Back to top

[Previous TableauDatasource](../tableaudatasource/) [Next TableauFlow](../tableauflow/) 
