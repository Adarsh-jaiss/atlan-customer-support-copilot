# Source URL
https://developer.atlan.com/models/entities/tableauproject/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/tableauproject/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/tableauproject.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: TableauProject - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/tableauproject/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/tableauproject.png
meta-twitter:title: TableauProject - Developer
meta-viewport: width=device-width,initial-scale=1
title: TableauProject - Developer
-->

[Skip to content](#tableauproject) Developer TableauProject Initializing search 
...
TableauProject[¶](#tableauproject "Permanent link")
===================================================
...
This is a complete reference for the `TableauProject` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`TableauProject` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class TableauProject
    link TableauProject "../tableauproject"
    class Tableau {
        <<abstract>>
    }
...
These attributes are inherited from `TableauProject`'s supertypes (shown above):
...
These attributes are specific to instances of `TableauProject` (and all of its subtypes).

### isTopLevelProject [¶](#istoplevelproject "Permanent link")
...
These relationships are inherited from `TableauProject`'s supertypes:
...
These relationships are specific to instances of `TableauProject` (and all of its subtypes).

### childProjects  ([TableauProject](./))[¶](#childprojects-tableauproject "Permanent link")

Sub\-projects that exist within this project.

### datasources  ([TableauDatasource](../tableaudatasource/))[¶](#datasources-tableaudatasource "Permanent link")

Datasources that exist within this project.

### flows  ([TableauFlow](../tableauflow/))[¶](#flows-tableauflow "Permanent link")

Flows that exist within this project.

### parentProject  ([TableauProject](./))[¶](#parentproject-tableauproject "Permanent link")

Project in which this sub\-project exists.

### site  ([TableauSite](../tableausite/))[¶](#site-tableausite "Permanent link")

Site in which this project exists.

### workbooks  ([TableauWorkbook](../tableauworkbook/))[¶](#workbooks-tableauworkbook "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/tableauproject/) to provide us with more information. 

Back to top

[Previous TableauMetric](../tableaumetric/) [Next TableauSite](../tableausite/) 
