# Source URL
https://developer.atlan.com/models/entities/task/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/task/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/task.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Task - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/task/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/task.png
meta-twitter:title: Task - Developer
meta-viewport: width=device-width,initial-scale=1
title: Task - Developer
-->

[Skip to content](#task) Developer Task Initializing search 
...
This is a complete reference for the `Task` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`Task` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `Task`'s supertypes (shown above):
...
These attributes are specific to instances of `Task` (and all of its subtypes).

### taskActions [¶](#taskactions "Permanent link")

List of actions associated with this task.

### taskCreatedBy [¶](#taskcreatedby "Permanent link")

username of the user who created this task

### taskExecutionAction [¶](#taskexecutionaction "Permanent link")

action executed by the recipient

### taskExecutionComment [¶](#taskexecutioncomment "Permanent link")

comment for the action executed by user

### taskExpiresAt [¶](#taskexpiresat "Permanent link")

Time (epoch) at which the task expires .

### taskIntegrationConfig [¶](#taskintegrationconfig "Permanent link")

contains external integration config for the task

### taskIsRead [¶](#taskisread "Permanent link")

flag to make task read/unread

### taskProposals [¶](#taskproposals "Permanent link")

contains the payload that is proposed to the task

### taskRecipient [¶](#taskrecipient "Permanent link")

recipient of the task

### taskRelatedAssetGuid [¶](#taskrelatedassetguid "Permanent link")

assetId to preview

### taskRequestor [¶](#taskrequestor "Permanent link")

requestor of the task

### taskRequestorComment [¶](#taskrequestorcomment "Permanent link")

comment of requestor for the task

### taskType [¶](#tasktype "Permanent link")

type of task

### taskUpdatedBy [¶](#taskupdatedby "Permanent link")
...
These relationships are inherited from `Task`'s supertypes:
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/task/) to provide us with more information. 

Back to top

[Previous WorkflowRun](../workflowrun/) [Next Structs](../../structs/) 
