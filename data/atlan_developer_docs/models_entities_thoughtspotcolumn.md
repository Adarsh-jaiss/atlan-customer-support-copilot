# Source URL
https://developer.atlan.com/models/entities/thoughtspotcolumn/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/thoughtspotcolumn/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/thoughtspotcolumn.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: ThoughtspotColumn - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/thoughtspotcolumn/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/thoughtspotcolumn.png
meta-twitter:title: ThoughtspotColumn - Developer
meta-viewport: width=device-width,initial-scale=1
title: ThoughtspotColumn - Developer
-->

[Skip to content](#thoughtspotcolumn) Developer ThoughtspotColumn Initializing search 
...
ThoughtspotColumn[¶](#thoughtspotcolumn "Permanent link")
=========================================================
...
This is a complete reference for the `ThoughtspotColumn` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`ThoughtspotColumn` inherits its attributes and relationships from these other types:
...
These attributes are inherited from `ThoughtspotColumn`'s supertypes (shown above):
...
These attributes are specific to instances of `ThoughtspotColumn` (and all of its subtypes).

### thoughtspotColumnDataType [¶](#thoughtspotcolumndatatype "Permanent link")

Specifies the technical format of data stored in a column such as integer, float, string, date, boolean etc.

### thoughtspotColumnType [¶](#thoughtspotcolumntype "Permanent link")

Defines the analytical role of a column in data analysis categorizing it as a dimension, measure, or attribute.

### thoughtspotTableQualifiedName [¶](#thoughtspottablequalifiedname "Permanent link")

Unique name of the table in which this column exists.

### thoughtspotViewQualifiedName [¶](#thoughtspotviewqualifiedname "Permanent link")

Unique name of the view in which this column exists.

### thoughtspotWorksheetQualifiedName [¶](#thoughtspotworksheetqualifiedname "Permanent link")
...
These relationships are inherited from `ThoughtspotColumn`'s supertypes:
...
These relationships are specific to instances of `ThoughtspotColumn` (and all of its subtypes).

### thoughtspotTable  ([ThoughtspotTable](../thoughtspottable/))[¶](#thoughtspottable-thoughtspottable "Permanent link")

TBC

### thoughtspotView  ([ThoughtspotView](../thoughtspotview/))[¶](#thoughtspotview-thoughtspotview "Permanent link")

TBC

### thoughtspotWorksheet  ([ThoughtspotWorksheet](../thoughtspotworksheet/))[¶](#thoughtspotworksheet-thoughtspotworksheet "Permanent link")
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/thoughtspotcolumn/) to provide us with more information. 

Back to top

[Previous ThoughtspotAnswer](../thoughtspotanswer/) [Next ThoughtspotDashlet](../thoughtspotdashlet/) 
