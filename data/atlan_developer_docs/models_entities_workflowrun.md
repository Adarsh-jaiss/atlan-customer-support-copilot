# Source URL
https://developer.atlan.com/models/entities/workflowrun/

================================================================================

<!--
canonical: https://developer.atlan.com/models/entities/workflowrun/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: Dear Developers
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: Dear Developers
meta-og-image: https://developer.atlan.com/assets/images/social/models/entities/workflowrun.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: WorkflowRun - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/models/entities/workflowrun/
meta-twitter:card: summary_large_image
meta-twitter:description: Dear Developers
meta-twitter:image: https://developer.atlan.com/assets/images/social/models/entities/workflowrun.png
meta-twitter:title: WorkflowRun - Developer
meta-viewport: width=device-width,initial-scale=1
title: WorkflowRun - Developer
-->

[Skip to content](#workflowrun) Developer WorkflowRun Initializing search 
...
WorkflowRun[¶](#workflowrun "Permanent link")
=============================================
...
This is a complete reference for the `WorkflowRun` object in Atlan, showing every possible property and relationship that can exist for these objects. For an introduction, you probably want to start with:

* [Snippets](../../../snippets/) — small, atomic examples of single\-step use cases.
* [Patterns](../../../patterns/) — walkthroughs of common multi\-step implementation patterns.

`WorkflowRun` inherits its attributes and relationships from these other types:

```
classDiagram
    direction RL
    class WorkflowRun
    link WorkflowRun "../workflowrun"
    class Asset {
        <<abstract>>
    }
    link Asset "../asset"
...
These attributes are inherited from `WorkflowRun`'s supertypes (shown above):
...
These attributes are specific to instances of `WorkflowRun` (and all of its subtypes).

### workflowRunActionChoices [¶](#workflowrunactionchoices "Permanent link")

List of workflow run action choices.

### workflowRunComment [¶](#workflowruncomment "Permanent link")

The comment added by the requester

### workflowRunConfig [¶](#workflowrunconfig "Permanent link")

Details of the approval workflow run.

### workflowRunCreatedBy [¶](#workflowruncreatedby "Permanent link")

Username of the user who created this workflow run.

### workflowRunDeletedAt [¶](#workflowrundeletedat "Permanent link")

Deletion time of this workflow run.

### workflowRunExpiresAt [¶](#workflowrunexpiresat "Permanent link")

Time at which this run will expire.

### workflowRunOnAssetGuid [¶](#workflowrunonassetguid "Permanent link")
...
### workflowRunUpdatedBy [¶](#workflowrunupdatedby "Permanent link")

Username of the user who updated this workflow run.

### workflowRunWorkflowGuid [¶](#workflowrunworkflowguid "Permanent link")
...
These relationships are inherited from `WorkflowRun`'s supertypes:
...
Thanks for your feedback! Thanks for your feedback! Help us improve this page by using our [feedback form](https://docs.google.com/forms/d/e/1FAIpQLScfoq7vqEn8S4QvN0ehPp0MRy6WYK5x-okJDqD69lHgoPPWtg/viewform?usp=pp_url&entry.1800719315=/models/entities/workflowrun/) to provide us with more information. 

Back to top

[Previous Workflow](../workflow/) [Next Task](../task/) 
