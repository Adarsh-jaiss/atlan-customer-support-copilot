...
<!--
canonical: https://developer.atlan.com/sdks/java/
meta-content-security-policy: object-src 'none'; base-uri 'self'; manifest-src 'self'; media-src 'self';
meta-description: The Java SDK is available on Maven Central, ready to be included in your project.
meta-generator: mkdocs-1.6.1, mkdocs-material-9.6.14
meta-og-description: The Java SDK is available on Maven Central, ready to be included in your project.
meta-og-image: https://developer.atlan.com/assets/images/social/sdks/java.png
meta-og-image-height: 630
meta-og-image-type: image/png
meta-og-image-width: 1200
meta-og-title: Java SDK - Developer
meta-og-type: website
meta-og-url: https://developer.atlan.com/sdks/java/
meta-twitter:card: summary_large_image
meta-twitter:description: The Java SDK is available on Maven Central, ready to be included in your project.
meta-twitter:image: https://developer.atlan.com/assets/images/social/sdks/java.png
meta-twitter:title: Java SDK - Developer
